...
// source-sha256: 1c576109920aee99
// ============================================================
...
const BUILD_DATE = "2026-07-30 00:40"; // 更新のたびに手動で書き換える(日付+時刻、JST) ※version.jsonのbuildも同じ値に合わせること
...
function MonsterHeroGame() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "grid grid-cols-3 gap-2.5 pb-4"
  }, sortMonsterEntries(buildUnifiedMonsterEntries([], masuMons, monsterRosterIds)).filter(e => e.type === 'masu').map(({
    masu,
    base
  }) => {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: `relative rounded-2xl border-2 p-2 flex flex-col items-center gap-1 active:scale-95 ${selected ? 'border-emerald-300 bg-emerald-950/80 ring-2 ring-emerald-400/30' : 'border-slate-800 bg-slate-900'} disabled:opacity-35`
