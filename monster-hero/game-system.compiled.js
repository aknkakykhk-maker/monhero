...
// source-sha256: ed8510d500916bad
// ============================================================
  ...
  useEffect(() => {
    ...
    const required = async () => {
      ...
      await new Promise((resolve, reject) => {
        ...
        image.src = 'data/images/title-screen-clean.PNG';
