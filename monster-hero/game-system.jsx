...
const BUILD_DATE = "2026-07-26 15:51"; // 更新のたびに手動で書き換える(日付+時刻、JST) ※version.jsonのbuildも同じ値に合わせること
...
const MASU_COLOR_REGION_HUES = {
  ...
  // 口(染色③)は瞳を挟んで左右に分かれて見える三日月形で、色相判定だけだと輪郭が
  // ガビガビになっていたため、実測した輪郭に沿って段状の矩形を積み重ねている
  Suezo: [{ hue: 45, sMin: 0.3, vMin: 0.55 }, { hue: 45, sMin: 0.3, vMax: 0.55 }, { posBbox: [[0.304, 0.531, 0.327, 0.537], [0.304, 0.537, 0.333, 0.544], [0.311, 0.544, 0.689, 0.550], [0.317, 0.550, 0.683, 0.556], [0.317, 0.556, 0.677, 0.563], [0.323, 0.563, 0.677, 0.569], [0.330, 0.569, 0.670, 0.575], [0.336, 0.575, 0.664, 0.581], [0.342, 0.581, 0.658, 0.588], [0.342, 0.588, 0.652, 0.594], [0.348, 0.594, 0.645, 0.600], [0.361, 0.600, 0.639, 0.606], [0.367, 0.606, 0.633, 0.613], [0.373, 0.613, 0.621, 0.619], [0.386, 0.619, 0.614, 0.625], [0.398, 0.625, 0.602, 0.631], [0.411, 0.631, 0.589, 0.637], [0.423, 0.637, 0.577, 0.644], [0.442, 0.644, 0.558, 0.650], [0.467, 0.650, 0.527, 0.656]], noAAGuard: true, noEdgeGuard: true }],
