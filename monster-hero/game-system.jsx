...
const BUILD_DATE = "2026-07-26 05:30"; // 更新のたびに手動で書き換える(日付+時刻、JST) ※version.jsonのbuildも同じ値に合わせること
...
const MASU_COLOR_REGION_SIZE_OVERRIDES = {
  Tiger: {
    ...
    160: { 0: { posBbox: [[0.420, 0.163, 0.555, 0.181], [0.425, 0.181, 0.565, 0.200], [0.415, 0.200, 0.572, 0.219], [0.405, 0.219, 0.578, 0.269], [0.665, 0.30, 0.84, 0.65]] },
           2: { posBbox: [[0.84, 0.28, 1.0, 0.50]] } },
  },
};
