...
const BUILD_DATE = "2026-07-26 11:05"; // 更新のたびに手動で書き換える(日付+時刻、JST) ※version.jsonのbuildも同じ値に合わせること
...
const MASU_COLOR_REGION_HUES = {
  ...
  // 2026年に新規イラストへ差し替え。体(赤)・お腹や翼などの金/クリーム色・頭上のクレストの3部位。
  // クレストはお腹・翼とほぼ同じ色相(30〜35°)で色相だけでは安定して区別できず、染色時に
  // まだらになっていたため、色を問わず位置で強制するposBboxにして独立させている
  // (実測した輪郭の先細り形状に沿って複数の矩形を積み重ね、頬の赤色を誤って拾わないようにしている)
  Mitarashi: [{ hue: 0, sMin: 0.3 }, { hue: 35, sMin: 0.3 }, { posBbox: [[0.42, 0.05, 0.57, 0.10], [0.34, 0.10, 0.64, 0.16], [0.37, 0.16, 0.62, 0.22], [0.31, 0.22, 0.68, 0.35]] }],
