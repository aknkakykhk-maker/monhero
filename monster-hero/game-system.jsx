...
const BUILD_DATE = "2026-07-26 08:20"; // 更新のたびに手動で書き換える(日付+時刻、JST) ※version.jsonのbuildも同じ値に合わせること
...
const MASU_COLOR_REGION_HUES = {
  ...
  // 2026年に新規イラスト(悪魔っ子)へ差し替え。地肌(彩度0.05〜0.12)は染色対象外にし、
  // 髪(染色①、hue321前後)と衣装・翼(染色②、hue350前後、赤系だが髪より色相がやや黄寄り)を
  // sMinで肌を除外しつつ色相の近さで自動的に髪/衣装へ振り分ける
  Ark: [{ hue: 321, sMin: 0.18 }, { hue: 350, sMin: 0.18 }],
