...
const IDLE_TIGER_TAIL_MASK = "images/monsters/idle/tiger-tail.png?v=b4681fb63c99";
const IDLE_TIGER_BODY_MASK = "images/monsters/idle/tiger-body.png?v=13e72f9404a4";
const IDLE_HAM_EAR_L_MASK = "images/monsters/idle/ham-ear-l.png?v=5c8b1a7adfe5";
const IDLE_HAM_EAR_R_MASK = "images/monsters/idle/ham-ear-r.png?v=9d6ecd80ec47";
const IDLE_HAM_BODY_MASK = "images/monsters/idle/ham-body.png?v=eb2cacc04fa8";
const IDLE_PIXIE_WING_L_MASK = "images/monsters/idle/pixie-wing-l.png?v=6bc141c30c2b";
const IDLE_PIXIE_WING_R_MASK = "images/monsters/idle/pixie-wing-r.png?v=22764747bc7e";
const IDLE_PIXIE_TAIL_MASK = "images/monsters/idle/pixie-tail.png?v=fbe0584f8775";
const IDLE_PIXIE_BODY_MASK = "images/monsters/idle/pixie-body.png?v=597fd72b46a1";
const IDLE_MIA_WING_L_MASK = "images/monsters/idle/mia-wing-l.png?v=de6d7902d62e";
const IDLE_MIA_WING_R_MASK = "images/monsters/idle/mia-wing-r.png?v=4d827abada1f";
const IDLE_MIA_BODY_MASK = "images/monsters/idle/mia-body.png?v=c0972bb2c48f";
const IDLE_PANDORA_WING_L_MASK = "images/monsters/idle/pandora-wing-l.png?v=ebccdb530381";
const IDLE_PANDORA_WING_R_MASK = "images/monsters/idle/pandora-wing-r.png?v=212ed83e8f63";
const IDLE_PANDORA_TAIL_L_MASK = "images/monsters/idle/pandora-tail-l.png?v=28f6e251b9a8";
const IDLE_PANDORA_TAIL_R_MASK = "images/monsters/idle/pandora-tail-r.png?v=71eaf0ee4f68";
const IDLE_PANDORA_BODY_MASK = "images/monsters/idle/pandora-body.png?v=3b16cf264bdb";
const IDLE_OBORO_FLOWER_T_MASK = "images/monsters/idle/oboro-flower-t.png?v=e23567f302f2";
const IDLE_OBORO_FLOWER_L_MASK = "images/monsters/idle/oboro-flower-l.png?v=e31d34804f60";
const IDLE_OBORO_FLOWER_R_MASK = "images/monsters/idle/oboro-flower-r.png?v=17a95b3758cf";
const IDLE_OBORO_BODY_MASK = "images/monsters/idle/oboro-body.png?v=373811dc7e34";
const IDLE_PLANT_FLOWER_T_MASK = "images/monsters/idle/plant-flower-t.png?v=d3307bdd479a";
const IDLE_PLANT_FLOWER_L_MASK = "images/monsters/idle/plant-flower-l.png?v=780e9a05ae31";
const IDLE_PLANT_FLOWER_R_MASK = "images/monsters/idle/plant-flower-r.png?v=e5f138879342";
const IDLE_PLANT_BODY_MASK = "images/monsters/idle/plant-body.png?v=593a349d59b9";
const IDLE_ZAN_BLADE_L_MASK = "images/monsters/idle/zan-blade-l.png?v=906253133c4f";
const IDLE_ZAN_BLADE_R_MASK = "images/monsters/idle/zan-blade-r.png?v=43070d200f62";
const IDLE_ZAN_BODY_MASK = "images/monsters/idle/zan-body.png?v=92e8665c8c6c";
...
const IDLE_IBLIS_WING_L_MASK = "images/monsters/idle/iblis-wing-l.png?v=8d567a819b91";
const IDLE_IBLIS_WING_R_MASK = "images/monsters/idle/iblis-wing-r.png?v=bb8ee6c7578f";
const IDLE_IBLIS_ORB_MASK = "images/monsters/idle/iblis-orb.png?v=403676febfce";
const IDLE_IBLIS_BODY_MASK = "images/monsters/idle/iblis-body.png?v=de29effcca6b";
const IDLE_SNEGUROCHKA_FIN_MASK = "images/monsters/idle/snegurochka-fin.png?v=409892bea6fa";
const IDLE_SNEGUROCHKA_BODY_MASK = "images/monsters/idle/snegurochka-body.png?v=cf5e5fa1c039";
const IDLE_UNDINE_FIN_MASK = "images/monsters/idle/undine-fin.png?v=19ecceae44f1";
const IDLE_UNDINE_BODY_MASK = "images/monsters/idle/undine-body.png?v=ba3c27e60378";
const IDLE_YAOBIKUNI_FIN_MASK = "images/monsters/idle/yaobikuni-fin.png?v=9a1be9a77c2a";
const IDLE_YAOBIKUNI_BODY_MASK = "images/monsters/idle/yaobikuni-body.png?v=4bd467b57da2";
// ==== 待機アニメのマスク ここまで ====
