...
// DEBUG ONLY: 体験版の先行公開曲「Monster Hero」のEASY正式候補v1。
// tools/mode/rhythm-monster-hero-easy-build.js が実音源のオンセット解析から決定的に組み立て、
// 下のマーカーの内側だけを書き換える。手で書き換えず、方針を変えるときはツール側を直す。
//
// 1行 = [timeMs, subLane, holdMs, monsterSlot]（holdMs=0はTAP / monsterSlot=0は通常ノーツ）
// 耳確認前の制作候補であり、正式完成譜面ではない。デバッグ導線でだけ遊べる状態にしてある。
const monsterHeroEasyRows = Object.freeze([
// <monster-hero-easy-notes>
  [5577,2,0,0],[6097,4,693,0],[10948,2,0,0],[11988,4,0,0],[13200,2,0,0],[14413,4,0,0],
  [14760,6,0,0],[16146,4,0,0],[16319,4,0,0],[17185,6,0,0],[18571,4,0,0],[20650,6,0,0],
  [20997,4,0,0],[21690,2,0,0],[23423,4,0,0],[24289,2,0,0],[25502,4,0,0],[25848,6,693,0],
  [27061,4,0,0],[27754,2,0,0],[28967,4,0,0],[29313,2,0,0],[29487,2,0,0],[30699,4,0,0],
  [31046,6,0,0],[31392,8,0,0],[31739,6,0,0],[32432,4,0,0],[32952,2,0,0],[33298,0,0,0],
  [34511,2,0,1],[35897,0,0,0],[37283,2,0,0],[37630,0,0,0],[38496,2,0,0],[39016,4,0,0],
  [39362,6,0,0],[39709,8,0,0],[40228,6,0,0],[40575,4,0,0],[41615,2,0,0],[41961,4,0,0],
  [44213,2,693,0],[45253,4,0,0],[46119,2,0,0],[47159,0,0,0],[48025,2,693,0],[49931,0,0,0],
  [50451,2,0,0],[51144,4,0,0],[51837,2,0,0],[52703,0,0,0],[53223,2,0,0],[53396,2,0,0],
  [54089,4,0,0],[54782,2,0,0],[55475,0,0,0],[55648,2,0,0],[56168,4,0,0],[57381,2,0,0],
  [58247,0,0,0],[59114,2,0,0],[59633,4,0,0],[60846,2,0,0],[61539,4,0,0],[61886,6,0,0],
  [62752,4,0,0],[63445,2,0,0],[64311,4,0,2],[64658,6,0,0],[65178,8,0,0],[65871,6,0,0],
  [66564,4,0,0],[67776,6,0,0],[68123,4,0,0],[68989,2,0,0],[71761,0,0,0],[72628,2,0,0],
  [72974,4,0,0],[73494,6,0,0],[74360,4,693,0],[75746,6,0,0],[76093,8,0,0],[76439,6,0,0],
  [77306,4,0,0],[77652,2,0,0],[78865,4,0,0],[79038,4,0,0],[79731,2,0,0],[80424,0,0,0],
  [80944,2,0,0],[81637,4,0,0],[81810,4,0,0],[82330,2,0,0],[83196,0,0,0],[83370,2,0,0],
  [84063,4,0,0],[84409,6,693,0],[85795,4,0,0],[85968,4,0,0],[86488,6,0,0],[86661,6,0,0],
  [88567,4,0,0],[89607,6,0,0],[89953,8,0,0],[90993,6,0,0],[91166,6,0,0],[91513,4,0,0],
  [91686,6,0,0],[92379,8,0,3],[92726,6,0,0],[93072,4,0,0],[94112,2,0,0],[95151,4,0,0],
  [95498,6,0,0],[95671,6,0,0],[96884,4,693,0],[98270,6,0,0],[98616,4,0,0],[99309,2,0,0],
  [99829,0,0,0],[100002,2,0,0],[100349,4,0,0],[101215,6,0,0],[102081,4,0,0],[102601,2,0,0],
  [103814,4,0,0],[105547,6,0,0],[106240,8,0,0],[106586,6,0,0],[106759,6,0,0],[107972,4,0,0],
  [110398,2,0,0],[111957,4,0,0],[112304,6,0,0],[113516,4,693,0],[114902,6,0,0],[115076,6,0,0],
  [116289,4,0,0],[116982,6,0,0],[117848,8,0,0],[118368,6,0,0],[118541,6,0,0],[120620,8,0,0],
  [121486,6,0,0],[121660,6,0,0],[122699,8,0,0],[123392,6,0,0],[124605,4,0,4],[126164,6,0,0],
  [127030,4,0,0],[127377,2,693,0],[128590,4,0,0],[130149,2,0,0],[130496,4,0,0],[130669,4,0,0],
  [131015,6,0,0],[131362,8,0,0],[132228,6,0,0],[133095,4,0,0],[134307,6,0,0],[134481,6,0,0],
  [136560,8,0,0],[136906,6,0,0],[137426,4,0,0],[141238,2,0,0],[141411,2,0,0],[141931,4,0,0],
  [142624,6,0,0],[142797,6,0,0],[143143,4,0,0],[144703,6,0,0],[145742,4,693,0],[147995,6,0,0],
  [149554,4,0,0],[149727,4,0,0],
// </monster-hero-easy-notes>
]);
const monsterHeroEasyNotes = Object.freeze(monsterHeroEasyRows.map(([timeMs,subLane,holdMs,monsterSlot])=>Object.freeze({
  type:holdMs>0?'HOLD':'TAP',
  timeMs,
  ...(holdMs>0?{endTimeMs:timeMs+holdMs}:{}),
  lane:Math.floor(subLane/2),subLane,subLaneWidth:2,
  ...(monsterSlot?{monsterSlot}:{}),
})));
const MONSTER_HERO_EASY_DURATION_MS=152761;
const monsterHeroEasyChart = Object.freeze({level:1,notes:monsterHeroEasyNotes,totalNotes:monsterHeroEasyNotes.length,durationMs:MONSTER_HERO_EASY_DURATION_MS});
...
const RHYTHM_SONGS = Object.freeze([
  ...
  Object.freeze({
    songId:'monster_hero_theme_easy_candidate',
    displayName:'Monster Hero EASY候補',
    debugDescription:'体験版EASYの正式候補v1（全尺2分32秒・耳確認前）',
    bgmTrackId:'monster_hero_theme',
    // 全尺で遊ぶ曲なので playDurationMs（短縮再生の指定）は持たせない。
    // 終了は chart.durationMs と音源の終わりで決まる。
    difficulties:Object.freeze(Object.fromEntries(RHYTHM_DIFFICULTIES.map(({id})=>[id,id==='EASY'?monsterHeroEasyChart:emptyRhythmChart()])))
  }),
  Object.freeze({
