...
// レーンの外側・上端寄りの左右に台形へ入らない黒い余白が大きく残り、「せっかく空いている
// スペースを活かせていない」と指摘された(2026-09-03)。この余白は元々、HUD本文を台形の
// 外側ウェッジへ押し込むために意図して確保していたが、HUDをプレイエリアの外側(上の帯)へ
// 出したことで(RhythmTapTestの<header data-rhythm-hud>を参照)不要になったので、
// 奥行きの収束方向(上が狭い・下が判定ラインで広い)自体は変えず、上端の余白だけを
// 大きく減らして画面の上のほうまでレーンが見えるようにする(暫定値。実機の感触を見て調整する)。
