...
const installRhythmGeometryStyles=()=>{
  ...
  style.textContent=`
    ...
    /* 軽量モードは描画負荷を下げるための設定。RhythmTapTest側のinline styleは
       effectAmountに応じてプレイエリア全体へsaturate()を掛けるが、全画面filterは
       iPhone Safariで追加の合成レイヤー/オフスクリーン描画を要求しうる。
       軽量モード中だけpost-filterを外し、通常モード/演出量の見た目には触れない。 */
    [data-rhythm-play-area][data-rhythm-lightweight="true"]{filter:none!important}
