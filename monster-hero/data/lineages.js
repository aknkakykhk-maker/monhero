...
const MONSTER_LINEAGE_MAP = {
  ...
  // 剣士モッチー: モッチーの血に「？？？」が混ざったレア。正式実装まではデバッグ専用(debugOnly)
  KenshiMocchi:{ main:'mocchi', sub:'unknown' },
...
const MONSTER_DEX_DESCRIPTIONS = {
  ...
  KenshiMocchi: 'モッチー種でありながら二刀の剣を背負う、風変わりなモンスター。人にも物にも動じない飄々とした気性で、抜いた刃の速さだけが正体を語るという。どこで剣を覚えたのかは誰も知らない。',
