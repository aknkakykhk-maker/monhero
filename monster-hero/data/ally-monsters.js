...
const ALL_PLAYER_MONSTERS = {
  Mocchi: { id:'Mocchi', name:"モッチー", emoji:"🍡", imgUrl:MOCCHI_IMG, iconUrl:MOCCHI_ICON, faceIconUrl:MOCCHI_FACE_ICON, atkMotion:'default', trait:"もち肌", traitDesc:"勇者モン選択時：被ダメージ20%軽減", baseHp:600, baseGuts:100, baseAtk:120, baseDef:120, plusStats:{hp:250,atk:30,def:30,guts:10}, distAptitude:['C','C','C','C'], unique:{name:"モッチ砲",icon:MOCCHI_ICON,monId:"Mocchi",baseMult:2.2,baseGuts:44,evoLevel:0,names:["モッチ砲","大モッチ砲","超モッチ砲","超モッチ砲2","超モッチ砲3","超モッチ砲ゴッド","超モッチ砲ブルー","身勝手のモッチ砲 兆","身勝手のモッチ砲 極"],effectDesc:"攻防一体：味方の被ダメージ3%軽減(永続)＆敵被ダメ10%増(WAVE限定)"}},
  ...
  Mitarashi: { id:'Mitarashi', name:"ミタラシ", emoji:"🐉", imgUrl:MITARASHI_IMG, iconUrl:MITARASHI_ICON, faceIconUrl:MITARASHI_FACE_ICON, atkMotion:'default', trait:"もち肌", traitDesc:"勇者モン選択時：被ダメージ20%軽減", baseHp:600, baseGuts:100, baseAtk:120, baseDef:120, plusStats:{hp:250,atk:30,def:30,guts:10}, distAptitude:['D','D','B','B'], unique:{name:"モッチ砲",icon:MITARASHI_ICON,monId:"Mitarashi",baseMult:2.2,baseGuts:44,evoLevel:0,names:["モッチ砲","大モッチ砲","超モッチ砲","超モッチ砲2","超モッチ砲3","超モッチ砲ゴッド","超モッチ砲ブルー","身勝手のモッチ砲 兆","身勝手のモッチ砲 極"],effectDesc:"攻防一体：味方の被ダメージ3%軽減(永続)＆敵被ダメ10%増(WAVE限定)"}},
