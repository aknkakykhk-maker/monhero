...
const ALL_PLAYER_MONSTERS = {
  ...
  Ark:    { id:'Ark',    name:"アーク", emoji:"🦊", imgUrl:ARK_IMG, iconUrl:ARK_ICON, faceIconUrl:ARK_FACE_ICON, atkMotion:'floatStab', trait:"中二病", traitDesc:"勇者モン選択時：敵の攻撃を2回まで被ダメージ50%カット(WAVE毎に回数リセット)＆固有技使用時、消費ガッツ10%増・ダメージ倍率+0.1(永続/重複可)", baseHp:440, baseGuts:120, baseAtk:130, baseDef:90, plusStats:{hp:210,atk:50,def:30,guts:30}, distAptitude:['E','B','C','B'], unique:{name:"祈れ輪廻の環よ",icon:ARK_ICON,monId:"Ark",baseMult:2.8,baseGuts:56,evoLevel:0,names:["祈れ輪廻の環よ","裁きの光よ下れ","今こそ真なる目醒め","聖夜の鐘を鳴響け","熾天の剣よ降り立て","聖光よ奇跡を灯せ","終焉に救いを与えよ","天の慈悲を示されよ","永劫の贖いを全うせよ"],effectDesc:"贖罪：与ダメの20%で追撃＆次ターン消費ガッツ15%増・被ダメージ50%減(1回)"}},
  Iblis:  { id:'Iblis',  name:"イブリース", emoji:"🐏", imgUrl:IBLIS_IMG, iconUrl:IBLIS_ICON, faceIconUrl:IBLIS_FACE_ICON, atkMotion:'floatStab', trait:"中二病", traitDesc:"勇者モン選択時：敵の攻撃を2回まで被ダメージ50%カット(WAVE毎に回数リセット)＆固有技使用時、消費ガッツ10%増・ダメージ倍率+0.1(永続/重複可)", baseHp:360, baseGuts:125, baseAtk:145, baseDef:75, plusStats:{hp:180,atk:60,def:25,guts:35}, distAptitude:['D','B','E','B'], unique:{name:"祈れ輪廻の環よ",icon:IBLIS_ICON,monId:"Iblis",baseMult:2.8,baseGuts:56,evoLevel:0,names:["祈れ輪廻の環よ","裁きの光よ下れ","今こそ真なる目醒め","聖夜の鐘を鳴響け","熾天の剣よ降り立て","聖光よ奇跡を灯せ","終焉に救いを与えよ","天の慈悲を示されよ","永劫の贖いを全うせよ"],effectDesc:"贖罪：与ダメの20%で追撃＆次ターン消費ガッツ15%増・被ダメージ50%減(1回)"}},
