const HERO_ATK_NAMES = {
  ...
  Mia:    ["はり手","レイ","サンダー","ハイキック","ヒールレイド","ライトニング","メガレイ","なげキッス","ディープキッス"],
...
const ALL_PLAYER_MONSTERS = {
  Mocchi: { id:'Mocchi', name:"モッチー", emoji:"🍡", imgUrl:MOCCHI_IMG, iconUrl:MOCCHI_ICON, faceIconUrl:MOCCHI_FACE_ICON, atkMotion:'default', trait:"もち肌", traitDesc:"勇者モン選択時：被ダメージ20%軽減", baseHp:600, baseGuts:100, baseAtk:120, baseDef:120, plusStats:{hp:250,atk:30,def:30,guts:10}, distAptitude:['C','C','C','C'], unique:{name:"モッチ砲",icon:MOCCHI_ICON,monId:"Mocchi",baseMult:2.2,baseGuts:44,evoLevel:0,names:["モッチ砲","大モッチ砲","超モッチ砲","超モッチ砲2","超モッチ砲3","超モッチ砲ゴッド","超モッチ砲ブルー","身勝手のモッチ砲 兆","身勝手のモッチ砲 極"],effectDesc:"攻防一体：敵被ダメ10%増(WAVE限定/このターンから)＆味方の被ダメージ3%軽減(永続/次のターンから)"}},
  ...
  Mia:    { id:'Mia',    name:"ミーア", emoji:"🧚", imgUrl:MIA_IMG, iconUrl:MIA_ICON, faceIconUrl:MIA_FACE_ICON, atkMotion:'default', trait:"魔力開放", traitDesc:"勇者モン選択時：固有技のダメージが2倍", baseHp:300, baseGuts:180, baseAtk:175, baseDef:60, plusStats:{hp:120,atk:30,def:10,guts:65}, distAptitude:['G','C','A','B'], unique:{name:"バン",icon:MIA_ICON,monId:"Mia",baseMult:2.1,baseGuts:42,evoLevel:0,names:["バン","ギガレイ","ギガサンダー","ビッグバン","ギガライトニング","コズミッグバン","テラレイ","テラバン","ドラゴ・ノヴァ"],effectDesc:"魔法空間：次ターン、カード消費ガッツ0"}},
  ...
  Plant:  { id:'Plant',  name:"プラント", emoji:"🌱", imgUrl:PLANT_IMG, iconUrl:PLANT_ICON, faceIconUrl:PLANT_FACE_ICON, atkMotion:'default', trait:"吸収", traitDesc:"勇者モン選択時：30%の確率で被ダメをHP(100%)とG(10%)へ変換", baseHp:930, baseGuts:120, baseAtk:100, baseDef:65, plusStats:{hp:620,atk:10,def:0,guts:15}, distAptitude:['C','D','F','A'], unique:{name:"種ガン",icon:PLANT_ICON,monId:"Plant",baseMult:2.0,baseGuts:40,evoLevel:0,names:["種ガン","葉っぱブレード","花粉","キンプン","種マシンガン","フラワービーム","乱れ咲き","蒼花爆散","クリスマスツリー"],effectDesc:"ドレイン：与ダメの50%ライフ回復、与ダメの5%ガッツ回復"}},
  ...
  // 勇者特性「二刀流」と固有効果「ソードスキル」の実体は次の3か所。
  ...
  KenshiMocchi: { id:'KenshiMocchi', name:"剣士モッチー", emoji:"🗡️", imgUrl:KENSHI_MOCCHI_IMG, iconUrl:KENSHI_MOCCHI_ICON, faceIconUrl:KENSHI_MOCCHI_FACE_ICON, atkMotion:'kenshiTwinBlade', trait:"二刀流", traitDesc:"勇者モン選択時：同時使用可能枚数+1。通常攻撃のダメージが50%になる代わりに、与ダメージ50%の連撃を行う。自身の固有技使用時は、与ダメージ10%の連撃を3回追加。", baseHp:350, baseGuts:130, baseAtk:185, baseDef:25, plusStats:{hp:200,atk:55,def:20,guts:25}, distAptitude:['A','A','C','D'], unique:{name:"ソニック・リープ",icon:KENSHI_MOCCHI_ICON,monId:"KenshiMocchi",baseMult:2.4,baseGuts:48,evoLevel:0,names:["ソニック・リープ","ホリゾンタル・スクエア","ヴォーパル・ストライク","デュアル・サーキュラー","ブラック・テンペスト","ブラック・チェイン","ナイトメア・レイド","ジ・エクリプス","スターバースト・ストリーム"],effectDesc:"ソードスキル：与ダメ20%で連撃×2＆連撃ダメージ+3%・連撃パワー+1(永続/重複可/次のターンから)。連撃パワー3充填ごとに与ダメ10%の連撃+1(永続/重複可/上限なし)"}},
