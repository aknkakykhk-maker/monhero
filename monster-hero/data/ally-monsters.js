...
const ALL_PLAYER_MONSTERS = {
  Mocchi: { id:'Mocchi', name:"モッチー", emoji:"🍡", imgUrl:MOCCHI_IMG, iconUrl:MOCCHI_ICON, faceIconUrl:MOCCHI_FACE_ICON, atkMotion:'default', trait:"もち肌", traitDesc:"勇者モン選択時：被ダメージ20%軽減", baseHp:600, baseGuts:100, baseAtk:120, baseDef:120, plusStats:{hp:250,atk:30,def:30,guts:10}, distAptitude:['C','C','C','C'], unique:{name:"モッチ砲",icon:MOCCHI_ICON,monId:"Mocchi",baseMult:2.2,baseGuts:44,evoLevel:0,names:["モッチ砲","大モッチ砲","超モッチ砲","超モッチ砲2","超モッチ砲3","超モッチ砲ゴッド","超モッチ砲ブルー","身勝手のモッチ砲 兆","身勝手のモッチ砲 極"],effectDesc:"攻防一体：味方丈夫さ3%増(永続)＆敵被ダメ10%増(WAVE限定)"}},
  ...
  // ゴーレムは「一撃が重い代わりにガッツが続かない」重量級。ただし調整前は
  //   ・ちから250が2位(ピクシー160)の1.56倍あり、通常技1発が2位の1.88倍だった
  //   ・最大ガッツ70に対して合掌の消費が68で、自動回復(最大の5%=3)では
  //     初めて合掌を撃てるのが11ターン目。他11種は全員1ターン目に撃てる
  // という形で、長所と短所がどちらも極端になっていた。合掌が撃てない=固有効果の
  // 「闘志」も積めないため、看板の必殺技がほとんど出番のないまま終わっていた。
  // ちからと供モンのちから加算を下げてピークを抑え、そのぶんガッツ回りを楽にして
  // 合掌を3ターン目から撃てるようにしている(重量級の性格そのものは変えない)。
  Golem:  { id:'Golem',  name:"ゴーレム", emoji:"🗿", imgUrl:GOLEM_IMG, iconUrl:GOLEM_ICON, faceIconUrl:GOLEM_FACE_ICON, atkMotion:'default', trait:"怪力", traitDesc:"勇者モン選択時：与ダメージ20%増加", baseHp:650, baseGuts:90, baseAtk:200, baseDef:160, plusStats:{hp:400,atk:60,def:0,guts:0}, distAptitude:['A','C','E','G'], unique:{name:"合掌",icon:GOLEM_ICON,monId:"Golem",baseMult:3.2,baseGuts:56,evoLevel:0,names:["合掌","フライングプレス","竜巻アタック","ぐるぐるアタック","大岩落とし","隕石落とし","超竜巻アタック","超ぐるぐるアタック","銀河破壊"],effectDesc:"闘志：味方攻撃力10%アップ(永続)"}},
  ...
  Oboro:  { id:'Oboro',  name:"オボロゲソウ", emoji:"🌾", imgUrl:OBORO_IMG, iconUrl:OBORO_ICON, faceIconUrl:OBORO_FACE_ICON, atkMotion:'default', trait:"吸収", traitDesc:"勇者モン選択時：30%の確率で被ダメをHP(100%)とG(10%)へ変換", baseHp:900, baseGuts:115, baseAtk:90, baseDef:60, plusStats:{hp:600,atk:0,def:0,guts:10}, distAptitude:['D','E','B','C'], unique:{name:"種ガン",icon:OBORO_ICON,monId:"Oboro",baseMult:2.0,baseGuts:40,evoLevel:0,names:["種ガン","葉っぱブレード","花粉","キンプン","種マシンガン","フラワービーム","乱れ咲き","蒼花爆散","クリスマスツリー"],effectDesc:"ドレイン：与ダメの50%ライフ回復、与ダメの5%ガッツ回復"}},
  ...
  Mitarashi: { id:'Mitarashi', name:"ミタラシ", emoji:"🐉", imgUrl:MITARASHI_IMG, iconUrl:MITARASHI_ICON, faceIconUrl:MITARASHI_FACE_ICON, atkMotion:'default', trait:"もち肌", traitDesc:"勇者モン選択時：被ダメージ20%軽減", baseHp:600, baseGuts:100, baseAtk:120, baseDef:120, plusStats:{hp:250,atk:30,def:30,guts:10}, distAptitude:['D','D','B','B'], unique:{name:"モッチ砲",icon:MITARASHI_ICON,monId:"Mitarashi",baseMult:2.2,baseGuts:44,evoLevel:0,names:["モッチ砲","大モッチ砲","超モッチ砲","超モッチ砲2","超モッチ砲3","超モッチ砲ゴッド","超モッチ砲ブルー","身勝手のモッチ砲 兆","身勝手のモッチ砲 極"],effectDesc:"攻防一体：味方丈夫さ3%増(永続)＆敵被ダメ10%増(WAVE限定)"}},
  Ark:    { id:'Ark',    name:"アーク", emoji:"🦊", imgUrl:ARK_IMG, iconUrl:ARK_ICON, faceIconUrl:ARK_FACE_ICON, atkMotion:'floatStab', trait:"被ダメカット", traitDesc:"勇者モン選択時：敵の攻撃を2回まで被ダメージ50%カット(WAVE毎に回数リセット)＆固有技使用時、消費ガッツ10%増・ダメージ倍率+0.1(永続/重複可)", baseHp:440, baseGuts:120, baseAtk:130, baseDef:90, plusStats:{hp:210,atk:50,def:30,guts:30}, distAptitude:['E','B','C','B'], unique:{name:"祈れ輪廻の環よ",icon:ARK_ICON,monId:"Ark",baseMult:2.8,baseGuts:56,evoLevel:0,names:["祈れ輪廻の環よ","裁きの光よ下れ","今こそ真なる目醒め","聖夜の鐘を鳴響け","熾天の剣よ降り立て","聖光よ奇跡を灯せ","終焉に救いを与えよ","天の慈悲を示されよ","永劫の贖いを全うせよ"],effectDesc:"贖罪：与ダメの20%で追撃＆次ターン消費ガッツ15%増・被ダメージ50%減(1回)"}},
  Iblis:  { id:'Iblis',  name:"イブリース", emoji:"🐏", imgUrl:IBLIS_IMG, iconUrl:IBLIS_ICON, faceIconUrl:IBLIS_FACE_ICON, atkMotion:'floatStab', trait:"被ダメカット", traitDesc:"勇者モン選択時：敵の攻撃を2回まで被ダメージ50%カット(WAVE毎に回数リセット)＆固有技使用時、消費ガッツ10%増・ダメージ倍率+0.1(永続/重複可)", baseHp:360, baseGuts:125, baseAtk:145, baseDef:75, plusStats:{hp:180,atk:60,def:25,guts:35}, distAptitude:['D','B','E','B'], unique:{name:"祈れ輪廻の環よ",icon:IBLIS_ICON,monId:"Iblis",baseMult:2.8,baseGuts:56,evoLevel:0,names:["祈れ輪廻の環よ","裁きの光よ下れ","今こそ真なる目醒め","聖夜の鐘を鳴響け","熾天の剣よ降り立て","聖光よ奇跡を灯せ","終焉に救いを与えよ","天の慈悲を示されよ","永劫の贖いを全うせよ"],effectDesc:"贖罪：与ダメの20%で追撃＆次ターン消費ガッツ15%増・被ダメージ50%減(1回)"}}
};
