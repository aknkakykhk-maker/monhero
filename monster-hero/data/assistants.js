...
addAssistantLinePack({
  ...
  lines: {
    rhythmSixLaneIntro: [
      ...
      { e:'wink', t:'MASTERには横フリックが出るよ。オレンジの《《《は左、黄緑の》》》は右へ払ってね！' },
...
addAssistantLinePack({
  ...
  lines: {
    rhythmSixLaneIntro: [
      ...
      { e:'normal', t:'MASTERには横フリックが出まつ。オレンジの《《《は左、黄緑の》》》は右へ払うの。' },
...
addAssistantLinePack({
  ...
  lines: {
    rhythmSixLaneIntro: [
      ...
      { e:'wink',    t:'MASTERは横フリックが出るよ。オレンジの《《《は左、黄緑の》》》は右に払うんだ！' },
...
addAssistantLinePack({
  ...
  lines: {
    rhythmSixLaneIntro: [
      ...
      { e:'normal', t:'MASTERには横フリックが出るで。オレンジの《《《は左、黄緑の》》》は右へ払うんや' },
...
addAssistantLinePack({
  ...
  lines: {
    nightmareDifficulty: [
      ...
      { e:'normal', t:'間合い適性がいつも以上に大事になるよ。編成をじっくり考えよう。' },
...
addAssistantLinePack({
  ...
  lines: {
    ...
    nightmareDifficulty: [
      ...
      { e:'normal',   t:'間合い適性が、いつも以上に大事になりまつ。' },
...
addAssistantLinePack({
  ...
  lines: {
    ...
    nightmareDifficulty: [
      ...
      { e:'normal',   t:'間合い適性がいつも以上に効いてくるよ。編成、ちゃんと考えて。' },
    ...
    pickHero: [
      ...
      { e:'normal',   t:'能力と間合い適性、ちゃんと見てからにしてね。' },
...
//   ③ SLIDE がなめらかに曲がる
//   ④ MASTER に横フリック(オレンジの《《《は左・黄緑の》》》は右。上へ払っても取れない)
...
const ASSISTANT_RHYTHM_SIX_LANE = [
  ...
  { who:'kiki',     e:'normal',   t:'MASTERには横フリックも出まつ。オレンジの《《《は左、黄緑の》》》は右へ払うの。' },
...
const ASSISTANT_BATTLE_TUTORIAL_BODY = [
  ...
  { id:'enemyTalk',    at:'BATTLE',        e:'normal',  title:'相手の情報', t:'敵の名前・いる距離・ライフバー。距離はこまめに変わるから要チェック！', spot:'enemyBar', wait:'next' },
  { id:'scanTalk',     at:'BATTLE',        e:'happy',   title:'敵をくわしく', t:'右上の「解析」を押すと、敵の技や次に何をしてくるかまで見られるよ。', spot:'enemyBar', wait:'next' },
  { id:'heroTalk2',    at:'BATTLE',        e:'normal',  title:'自分の情報', t:'左上の「ステータス」で、自分のライフ・ちから・丈夫さ・ガッツを確認できるよ。', spot:'heroStatus', wait:'next' },
  ...
  { id:'atkSeen',      at:'BATTLE',        e:'happy',   title:'よく入った！', t:'敵のライフがぐっと減ったね。距離がそろってると威力が全然ちがうんだ♪', spot:'enemyBar', wait:'next' },
  // ⑦ 技変更
...
const ASSISTANT_BATTLE_TUTORIAL_TACTICS_BODY = [
  ...
  { id:'tEnemyTalk',   at:'BATTLE',        e:'normal',  title:'相手の情報', t:'敵の名前・いる距離・ライフバー。距離はこまめに変わるから要チェック！', spot:'enemyBar', wait:'next' },
  ...
  { id:'tAtkSeen',     at:'BATTLE',        e:'happy',   title:'よく入った！', t:'敵のライフがぐっと減ったね。距離がそろってると威力が全然ちがうんだ♪', spot:'enemyBar', wait:'next' },
  // ⑦ 技変更
