...
const ASSISTANT_UPDATE_NOTICE_SCRIPTS = {
  ...
  update_notice_rhythm_symphony_v1: {
    ...
    dra: [
      ...
      { e:'normal',   t:'入賞したら超越の実と勇者の証な。3曲ぜんぶ遊べば、入賞しなくてもダイヤと虹のプシュケーが届くぞ' },
...
addAssistantLinePack({
  ...
  lines: {
    ...
    onboarding: [
      ...
      { e:'normal',   t:'{name}、まずは名前とアイコンからだな。あとで変えられるから悩まんでいい' },
      { e:'wink',     t:'分からんことがあったら、おでの吹き出しを押してくれ' },
      { e:'happy',    t:'一緒にモンスター育てていこうぜ。えへへ' },
      { e:'normal',   t:'焦らんでいいんよ。おでもゲーム作るとき、そんな感じだからな' },
    ],
    dailyMasuAdvice: [
      { e:'happy',    t:'マスモンを早く増やしたいなら、いい手があるんよ' },
      { e:'normal',   t:'クイックのBeginnerでWAVE2まで行って、そこで「あきらめる」を押す' },
      { e:'wink',     t:'WAVE2まで行くのが条件な。そこだけ間違えるなよ' },
      { e:'happy',    t:'{name}、時間ないときはこれでいいんよ。効率って大事だからな' },
      { e:'normal',   t:'おでが見つけたわけじゃないけどな。えへへ' },
    ],
    // ---- バトル ----
    battleChallenge: [
      { e:'normal',   t:'スコアで競うならチャレンジな。上のランキングも見てみ' },
      { e:'happy',    t:'{name}、記録に残るのはここのぶんだからな' },
      { e:'wink',     t:'難易度を上げると点も伸びる。届きそうなとこから上げてけ' },
      { e:'normal',   t:'編成を変えるだけで急に通ることもあるんよ' },
      { e:'happy',    t:'気負わんでいい。負けても減るもんはないからな' },
    ],
    battleQuick: [
      { e:'happy',    t:'サクッとやるならこれな。テンポが早いんよ' },
      { e:'normal',   t:'{name}、育成の回転はこっちが速い。数をこなしたいときに使え' },
      { e:'wink',     t:'∞周回にすると裏で回り続けるぞ。待ってるあいだモンビーでもやってろ' },
      { e:'normal',   t:'記録はチャレンジと別枠だから、気楽にやっていいんよ' },
      { e:'happy',    t:'おでもこういう、ながらでできるやつ好きなんよ' },
    ],
    battlePro: [
      { e:'normal',   t:'ここはベースモンだけの世界な。育てた子は連れていけない' },
      { e:'happy',    t:'{name}、腕の見せどころだぞ' },
      { e:'wink',     t:'素の性能だけで組むから、いつもの感覚だと足元すくわれるぞ' },
      { e:'normal',   t:'距離と相性をちゃんと見ろ。ここはごまかしが効かん' },
      { e:'troubled', t:'おでは何回かここで心を折られてる。えへへ……' },
    ],
    battleHelp: [
      { e:'normal',   t:'迷ったらまず解析な。敵の必殺技が読めるんよ' },
      { e:'happy',    t:'{name}、読めてから動くだけでだいぶ変わるぞ' },
      { e:'wink',     t:'カードの色で役割が分かる。赤が攻撃、緑が守り、みたいにな' },
      { e:'normal',   t:'距離が合ってないと威力が落ちる。そこだけは覚えとけ' },
      { e:'happy',    t:'説明を読むのは遠回りに見えて近道なんよ' },
    ],
    pickHero: [
      { e:'normal',   t:'最初の1体は効いてくるぞ。勇者特性をちゃんと見ろ' },
      { e:'happy',    t:'{name}、好きな子でいいんよ。愛着って地味に強い' },
      { e:'wink',     t:'迷ったら、守りが堅いやつにしとくと事故りにくいぞ' },
      { e:'normal',   t:'特性は全部のWAVEに効く。ここだけは適当に選ぶな' },
      { e:'happy',    t:'おでなら見た目で選ぶけどな。えへへ' },
    ],
    pickSlot: [
      { e:'normal',   t:'敵と同じ距離から殴ると強いんよ。そこ合わせろ' },
      { e:'happy',    t:'{name}、並びで戦いやすさが変わるからな' },
      { e:'wink',     t:'前が薄いと一気に崩れるぞ。おでの膝みたいにな' },
      { e:'normal',   t:'あとから入れ替えるのは大変だから、ここでちゃんと考えとけ' },
      { e:'happy',    t:'悩むのが楽しいとこでもあるんよ' },
    ],
    pickAlly: [
      { e:'happy',    t:'仲間が増えるぞ。どの子にする？' },
      { e:'normal',   t:'{name}、手薄な距離を埋めるやつを取ると安定する' },
      { e:'wink',     t:'同じ役割ばっかり集めると、そこ以外で詰むからな' },
      { e:'normal',   t:'あとのWAVEを見越して選ぶと楽になるぞ' },
      { e:'happy',    t:'好きな子を取るのもアリだけどな。えへへ' },
    ],
    pickProAllies: [
      { e:'normal',   t:'ここで組んだ面子で最後まで行くんよ。慎重にな' },
      { e:'happy',    t:'{name}、距離のばらけ方を見とけ' },
      { e:'wink',     t:'尖った編成は気持ちいいけど、こけると早いぞ' },
      { e:'normal',   t:'補い合える組み合わせのほうが、結局遠くまで行ける' },
      { e:'troubled', t:'おでは毎回ここで20分くらい唸ってる' },
    ],
    pickTeaching: [
      { e:'normal',   t:'教えは後半に効いてくるやつが多いんよ' },
      { e:'happy',    t:'{name}、いま困ってることを埋めるやつを取るといい' },
      { e:'wink',     t:'欲張って全部は取れないからな。優先順位な' },
      { e:'normal',   t:'重ねて取ると強くなるやつもあるぞ' },
      { e:'happy',    t:'おでの緑膝もそこに混じってるらしい。なんでだろな' },
    ],
    rewardPick: [
      { e:'happy',    t:'WAVEクリアおつかれ。トレーニングを2つえらべ' },
      { e:'normal',   t:'{name}、いま足りてないところを伸ばすのが基本な' },
      { e:'wink',     t:'攻撃ばっかり上げると、殴られて終わるぞ' },
      { e:'normal',   t:'あとのWAVEで何が来るか考えて選ぶといいんよ' },
      { e:'happy',    t:'ここの積み重ねが最後に効くからな' },
    ],
    skipPick: [
      { e:'normal',   t:'チケットで一気に育てられるんよ。枚数も選べる' },
      { e:'happy',    t:'{name}、時間ないときはこれでいい' },
      { e:'wink',     t:'ただしランキングには載らないからな。そこだけ承知で' },
      { e:'normal',   t:'難易度の高いチケットのほうが実入りはいいぞ' },
      { e:'happy',    t:'遊び方は自由なんよ。えへへ' },
    ],
    skipResult: [
      { e:'excited',  t:'受け取り完了な。一気に育ったじゃん' },
      { e:'happy',    t:'{name}、楽して伸ばすのも立派な戦略だぞ' },
      { e:'normal',   t:'この記録はランキングには送られてない。自己ベストもそのままな' },
      { e:'wink',     t:'貯め込んだチケットは使ってこそなんよ' },
      { e:'happy',    t:'おでも今度やってみるわ' },
    ],
    // ---- 極限・種族チャレンジ ----
    extremeChallenge: [
      { e:'normal',   t:'ここから先は極限な。チャレンジよりだいぶ手強いぞ' },
      { e:'happy',    t:'{name}、いけると思ったら行ってみ' },
      { e:'wink',     t:'一段ずつ開いていくから、焦らんでいい' },
      { e:'normal',   t:'記録は難易度ごとに別々に残るぞ' },
      { e:'troubled', t:'おでは上のほうで毎回すり潰されてる。えへへ' },
    ],
    extremeDifficulty: [
      { e:'normal',   t:'難易度えらびな。届きそうなとこから上げてけ' },
      { e:'happy',    t:'{name}、無理そうなら下げていい。恥ずかしくないんよ' },
      { e:'wink',     t:'上に行くほど敵が硬くなる。準備してから来い' },
      { e:'normal',   t:'クリアした組み合わせごとに記録が残るぞ' },
      { e:'happy',    t:'ひとつ上がるたびに世界が変わるからな' },
    ],
    nightmareDifficulty: [
      { e:'normal',   t:'ナイトメアな。ここから本気で組まんと通らんぞ' },
      { e:'happy',    t:'{name}、編成を見直してから来るといい' },
      { e:'wink',     t:'なんとなくで行くと、なんとなく負けるんよ' },
      { e:'normal',   t:'教えの取り方で通り方が変わるぞ' },
      { e:'troubled', t:'おでは初見で溶けた。えへへ……' },
    ],
    chaosDifficulty: [
      { e:'normal',   t:'カオスな。敵の圧が一段違うぞ' },
      { e:'happy',    t:'{name}、守りを厚くしとくと粘れる' },
      { e:'wink',     t:'一撃で持っていかれる場面があるから、解析はサボるな' },
      { e:'normal',   t:'ここは事故を減らすのが勝ち筋なんよ' },
      { e:'happy',    t:'通ったときは気持ちいいぞ' },
    ],
    ultimateDifficulty: [
      { e:'normal',   t:'アルティメットな。ここまで来たらもう相当なもんだぞ' },
      { e:'happy',    t:'{name}、おで普通に尊敬するわ' },
      { e:'wink',     t:'細かい積み重ねが全部効いてくる。手を抜くとこが無いんよ' },
      { e:'normal',   t:'負けても学べる。次に持っていけ' },
      { e:'troubled', t:'おでは見てるだけにしとくわ。膝が笑ってる' },
    ],
    infinityDifficulty: [
      { e:'normal',   t:'インフィニティな。もう終わりが無い世界だぞ' },
      { e:'happy',    t:'{name}、どこまで行けるか試してみ' },
      { e:'wink',     t:'長丁場になるから、無理せんとこで切り上げてもいいんよ' },
      { e:'normal',   t:'到達したところまでがちゃんと記録に残るぞ' },
      { e:'happy',    t:'おでは3分で音を上げた。えへへ' },
    ],
    godDifficulty: [
      { e:'normal',   t:'ゴッドな。名前のとおりだぞ' },
      { e:'happy',    t:'{name}、ここに挑む時点でおでより上な' },
      { e:'wink',     t:'運も絡むから、駄目な日は駄目なんよ。気にするな' },
      { e:'normal',   t:'準備を全部そろえてから来い。行き当たりばったりは通らん' },
      { e:'troubled', t:'おでは名前を見た時点で帰った' },
    ],
    ragnarokDifficulty: [
      { e:'normal',   t:'ラグナロクな。ここまで来る人、そうそういないぞ' },
      { e:'happy',    t:'{name}、もう説明することないんよ。好きにやってくれ' },
      { e:'wink',     t:'おでが言えるのは「無理はするな」くらいだな' },
      { e:'normal',   t:'届かなくても、そこまで積んだもんは消えんからな' },
      { e:'excited',  t:'通ったら教えてくれ。おで本気で祝うわ' },
    ],
    speciesChallenge: [
      { e:'normal',   t:'ひとつの種族だけで10WAVEな。しばりプレイだぞ' },
      { e:'happy',    t:'{name}、育ててる種族から挑むと入りやすい' },
      { e:'wink',     t:'普段の編成が使えんから、そこが面白いとこなんよ' },
      { e:'normal',   t:'はじめてクリアした組み合わせでは、その種族の超越の実がもらえるぞ' },
      { e:'happy',    t:'記録は種族ごとに別々だから、いつものぶんは変わらん' },
    ],
    // ---- モンビー(モンヒロビート) ----
    rhythmHelp: [
      { e:'normal',   t:'遊びかたはここに全部書いてあるぞ' },
    ...
    rhythmHistory: [
      ...
      { e:'happy',    t:'{name}、自分がどのへんにいたか残るのは嬉しいもんだぞ' },
      { e:'wink',     t:'前回より上がってたら、それはちゃんと成長な' },
      { e:'normal',   t:'終わった回の記録は変わらんから、落ち着いて見ていい' },
      { e:'happy',    t:'積み上がってくのを見るの、おで好きなんよ' },
    ],
    rhythmMonsters: [
      { e:'normal',   t:'ここで決めた子が、曲の途中で金のノーツになって出てくるぞ' },
      { e:'happy',    t:'{name}、お気に入りを入れとくと楽しいんよ' },
      { e:'wink',     t:'叩けると気持ちいいから、見やすい子にするのもアリだな' },
      { e:'normal',   t:'スコアには影響せん。完全に趣味の枠な' },
      { e:'happy',    t:'おでの顔は出せんのかな。えへへ' },
    ],
    quickRhythmIntro: [
      { e:'happy',    t:'∞周回にしたな。このままモンビーで遊べるぞ' },
      { e:'normal',   t:'{name}、周回は裏で続くから、待ってるあいだに1曲どうだ' },
      { e:'wink',     t:'戻りたくなったら左上の「戻る」でいつでも戻れるんよ' },
      { e:'normal',   t:'裏で回せるのはクイックの∞周回だけな。ほかは記録が絡むから' },
      { e:'happy',    t:'ながらで進むの、効率よくて好きなんよ' },
    ],
    quickRhythmBackground: [
      { e:'happy',    t:'ここにいるあいだも周回は進んでるぞ' },
      { e:'normal',   t:'{name}、演奏中だけは止まる。叩き終わればその曲のぶんが入るんよ' },
      { e:'wink',     t:'上の帯を押すと、何周めか見られるぞ' },
      { e:'normal',   t:'アプリを閉じるとそこで止まるからな。そこだけ注意な' },
      { e:'happy',    t:'二度おいしいってやつだな。えへへ' },
    ],
    autoQuickRunSettings: [
      { e:'normal',   t:'自動で回す設定な。自分のやりやすい形にしとけ' },
      { e:'happy',    t:'{name}、演出を切ると速く回るぞ' },
      { e:'wink',     t:'見たいとこだけ残すのがちょうどいいんよ' },
      { e:'normal',   t:'重いと思ったら軽くしろ。端末にやさしくな' },
      { e:'happy',    t:'おではだいたい全部切ってる' },
    ],
    // ---- 育成・管理 ----
    mbManagement: [
      { e:'normal',   t:'編成もベースモンもマスモンも、ここから見られるぞ' },
      { e:'happy',    t:'{name}、迷ったらここに戻ってくればいい' },
      { e:'wink',     t:'育てた子の確認はこまめにな。伸びしろに気づくぞ' },
      { e:'normal',   t:'種類の基本がベースモン、育てた個体がマスモンな' },
      { e:'happy',    t:'整理されてると気持ちいいんよ' },
    ],
    roster: [
      { e:'happy',    t:'編成な。誰を連れていく？' },
      { e:'normal',   t:'{name}、距離のばらけ方だけは見とけ' },
      { e:'wink',     t:'同じ役割で固めると、そこ以外で詰むぞ' },
      { e:'normal',   t:'絆が高い子は素の強さ以上に働くからな' },
      { e:'happy',    t:'好きな子を入れるのも、ちゃんとした理由なんよ' },
    ],
    monsterList: [
      { e:'normal',   t:'ベースモンが種類の基本、マスモンが育てた個体な' },
      { e:'happy',    t:'{name}、集まってくると眺めるだけで楽しいぞ' },
      { e:'wink',     t:'血統を見ると、伸びる方向が分かるんよ' },
      { e:'normal',   t:'並べ替えると探しやすいぞ' },
      { e:'happy',    t:'おでもコレクション癖あるからな。分かる' },
    ],
    masuList: [
      { e:'happy',    t:'育てた子が並んでるな。いい眺めだぞ' },
      { e:'normal',   t:'{name}、育ってない子も腐らせんなよ' },
      { e:'wink',     t:'絆Lvが上がると、できることが増えるんよ' },
      { e:'normal',   t:'お気に入りは牧場に出しとくといいぞ' },
      { e:'happy',    t:'手をかけたぶんはちゃんと返ってくるからな' },
    ],
    masuEnhance: [
      { e:'normal',   t:'ポイントは適性か能力値に使えるぞ' },
      { e:'happy',    t:'{name}、伸ばしたい方向を決めてから振れ' },
      { e:'wink',     t:'器用貧乏になると、どこでも中途半端になるんよ' },
      { e:'normal',   t:'振り直しは簡単じゃないから、落ち着いて決めろ' },
      { e:'troubled', t:'おでは勢いで振って後悔するタイプ。真似するなよ' },
    ],
    masuAutoEnhance: [
      { e:'normal',   t:'決めとけば、ポイントが入るたびにおでが振っといてやるぞ' },
      { e:'happy',    t:'{name}、いちいち画面を開かんで済むんよ' },
      { e:'wink',     t:'方針だけ決めときゃいい。あとは任せろ' },
      { e:'normal',   t:'途中で気が変わったら、いつでも変えていいぞ' },
      { e:'happy',    t:'楽できるとこは楽していいんよ。えへへ' },
    ],
    monsterDex: [
      { e:'happy',    t:'図鑑な。血統まで全部載ってるぞ' },
      { e:'normal',   t:'{name}、埋まってくると嬉しいもんだろ' },
      { e:'wink',     t:'見たことない子を探すのも楽しいんよ' },
      { e:'normal',   t:'血統をたどると、育て方の見当がつくぞ' },
      { e:'happy',    t:'おでもこういうの全部埋めたくなる' },
    ],
    temple: [
      { e:'normal',   t:'再生・合体・寄付な。今日はどれだ' },
      { e:'happy',    t:'{name}、どれも戻せないやつがあるから、確認してから押せ' },
      { e:'wink',     t:'迷ったら今日はやらん、でいいんよ' },
      { e:'normal',   t:'合体は「主」が残って「副」が消える。そこ間違えるな' },
      { e:'troubled', t:'おでは一回、間違えて大事な子を溶かしてる……' },
    ],
    fusion: [
      { e:'normal',   t:'「主」が残って「副」は消えるぞ。ちゃんと確認しろ' },
      { e:'happy',    t:'{name}、落ち着いて、もう一回見てからな' },
      { e:'wink',     t:'消えるほうを間違えると戻せんからな。マジで' },
      { e:'normal',   t:'受け継ぐものを見てから決めるといいぞ' },
      { e:'troubled', t:'おでの失敗談、ここでしたっけ。えへへ……' },
    ],
    rebirth: [
      { e:'happy',    t:'上限まで育てたごほうびだな' },
      { e:'normal',   t:'{name}、ここからさらに伸びるぞ' },
      { e:'wink',     t:'積み上げた時間がちゃんと形になるんよ' },
      { e:'normal',   t:'条件を満たした子だけができるやつな' },
      { e:'happy',    t:'こういう区切り、おで好きなんよ' },
    ],
    transcendence: [
      { e:'normal',   t:'Lv400まで育てた子だけが行ける、限界の先な' },
      { e:'happy',    t:'{name}、そこまで育てたのがもう偉いぞ' },
      { e:'wink',     t:'超越の実が要るからな。集めてから来い' },
      { e:'normal',   t:'ここまで来ると、もう別の生きものだぞ' },
      { e:'excited',  t:'おで、こういうの見るの好きなんよ' },
    ],
    reincarnate: [
      { e:'normal',   t:'Lv.100まで育てた子だけの特別なやつな' },
      { e:'happy',    t:'{name}、育て直すぶん強くなるぞ' },
      { e:'wink',     t:'一度リセットされるから、覚悟してから押せ' },
      { e:'normal',   t:'受け継ぐものと失うものを見てから決めろ' },
      { e:'happy',    t:'長く付き合う子ほど効いてくるんよ' },
    ],
    donation: [
      { e:'troubled', t:'寄付したマスモンは戻ってこんぞ。ほんとに戻せん' },
      { e:'normal',   t:'{name}、もう一回だけ考えてくれ' },
      { e:'wink',     t:'迷ってるなら今日はやめとけ。明日でもできる' },
      { e:'normal',   t:'決めたなら止めはせん。ちゃんと見返りはあるからな' },
      { e:'troubled', t:'おでは押す前に必ず一回閉じる。えへへ' },
    ],
    pasture: [
      { e:'happy',    t:'お気に入りを5体までHOMEに出せるぞ' },
      { e:'normal',   t:'{name}、見てると和むんよ' },
      { e:'wink',     t:'強さと関係ないとこだからこそ、好みで選べ' },
      { e:'normal',   t:'いつでも入れ替えられるからな' },
      { e:'happy',    t:'おでも並べたいけど、おでは助手だからな' },
    ],
    rankingParty: [
      { e:'normal',   t:'この人が使ってた編成だぞ。染めた色もそのまま出てる' },
      { e:'happy',    t:'{name}、強い人の組み方は素直に参考になるんよ' },
      { e:'wink',     t:'真似から入るの、恥ずかしいことじゃないからな' },
      { e:'normal',   t:'距離の埋め方を見るといいぞ' },
      { e:'happy',    t:'おでもよそのゲーム見て勉強してる' },
    ],
    giftEmpty: [
      { e:'normal',   t:'いまは未受取なしな。きれいなもんだ' },
      { e:'happy',    t:'{name}、ちゃんと受け取ってて偉いぞ' },
