...
const ASSISTANT_SCENES = {
  ...
  rhythmMonsters: {
    help: 'basics/rhythm-monster-note-display',
    lines: [],
  },
...
const ASSISTANT_RHYTHM_TUTORIAL_SETS = {
  ...
  momosuke: [
    ...
    { e:'normal',  t:'いまは体験版で、先行公開の5曲をEASY〜MASTERで遊べるよ。譜面はまだ調整中だから変わるかも。', title:'いまは体験版だよ', help:'basics/rhythm-demo-song' },
    ...
    { e:'surprise', t:'EXPERTとMASTERは最初は鍵つき。1つ下の難易度をクリアすれば開くよ。……開けられる？', title:'EXPERT以上は解放式', spot:'difficulty', help:'basics/rhythm-difficulty-unlock' },
    { e:'normal',  t:'ノーツは4種類。TAPは押す、HOLDは押さえ続ける、FLICKは払う、SLIDEはなぞる。かんたんでしょ？', title:'ノーツは4種類', help:'basics/rhythm-mode' },
    { e:'happy',   t:'タイミングが合うほどいい判定になるよ。MARVELOUS→EXCELLENT→GREAT→GOOD→BADの順ね。', title:'判定は5段階', help:'basics/rhythm-mode' },
    { e:'excited', t:'続けて取るとコンボ！ 全部つなげば「フルコンボ」だよ♪ そこから上の称号もあるんだから♡', title:'コンボをつなごう', help:'basics/rhythm-notes-and-effects' },
    { e:'normal',  t:'設定したマスモンは「モンスターノーツ」になって流れてくるの。取ると血統ごとの力が働くよ。', title:'マスモンも一緒に', spot:'monsters', help:'basics/rhythm-monster-note-display' },
    { e:'happy',   t:'ノーツの速さや音量、判定のタイミング補正はオプションでいじれるよ。合わないなら早めにね。', title:'オプション', spot:'options', help:'basics/rhythm-options-controls' },
    { e:'excited', t:'スコアは全国ランキングに載るよ！ 難易度をまたいだ合算だから、上でやるほど有利♪', title:'全国ランキング', help:'basics/rhythm-ranking' },
