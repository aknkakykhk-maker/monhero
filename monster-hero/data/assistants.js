...
//   ③ 敵の顔ぶれがまるごと入れ替わった
//   ④ 敵の技の種類が増えた(薙ぎ払い・連撃・貫通撃・咆哮・再生・全体攻撃)
//
...
const ASSISTANT_TACTICS_INTRO = [
  ...
  { who:'mua',      e:'surprise', t:'えっ、パーティ全員の合計じゃないの！？' },
  { who:'dra',      e:'normal',   t:'そう。だから誰が狙われてるかで、守る子も変わってくるんよ' },
  { who:'kiki',     e:'normal',   t:'それに、勇者特性が供モンにも効きまつ。持っている子ご本人に、でつね。' },
  { who:'momosuke', e:'surprise', t:'えっ、ももの特性も使えるんだ。……それ、けっこう大きくない？' },
  { who:'dra',      e:'happy',    t:'そうなんよ。連れていく子を、合計値じゃなくて「どの特性か」で選ぶことになる' },
  ...
  { who:'dra',      e:'troubled', t:'しかも技の種類が増えてるんだよ。薙ぎ払いに連撃、ガードが効かないやつまでな' },
