...
const ASSISTANT_SCENES = {
  ...
  monsterDex: {
    ...
    lines: [
      ...
      { e:'wink',    t:'まだ出会ってない子はシルエット。集めがいがあるよね！' },
...
addAssistantLinePack({
  ...
  lines: {
    masuAutoEnhance: [
      { e:'excited', t:'ここで決めておけば、強化ポイントが入るたびに、あたしが振っておくよ♪' },
      ...
      { e:'troubled', t:'振る先を1つも決めてないと、ONでも何も起きないから気をつけてね…。' },
      { e:'excited', t:'{name}が見てないあいだも働いてるからね！ えらいでしょ♪', bond:4 },
    ],
  },
});
...
addAssistantLinePack({
  ...
  lines: {
    ...
    rhythmMonsters: [
      ...
      { e:'happy', t:'GREATより良い判定で取れたら、その子の能力が出るよ！' },
      { e:'normal', t:'能力は主血統で決まるの。育てても染めても変わらないよ。' },
      { e:'wink', t:'ライフがきついなって思ったら、元気の子や無敵の子を入れてみて！' },
      { e:'happy', t:'{name}のいちばん好きな子を入れてもいいんだよ。かわいいから♪' },
    ],
    rhythmHelp: [
...
addAssistantLinePack({
  ...
  lines: {
    ...
    rhythmMonsters: [
      ...
      { e:'happy',   t:'GREATより良い判定で取れたら、その子の能力が出まつ♪' },
      { e:'normal',  t:'能力は主血統で決まりまつ。育てても染めても変わりません。' },
      { e:'wink',    t:'ライフが厳しいときは、元気の子か無敵の子をどうぞ。' },
      { e:'happy',   t:'{name}のお気に入りを入れるのでも、もちろんいいでつよ♪' },
    ],
    rhythmHelp: [
    ...
    infinityDifficulty: [
      { e:'normal',   t:'最後に控えているのがINFINITY。極限の総決算でつ。' },
      { e:'surprise', t:'加入ボーナスは最低10%まで下がりまつ。早めの合流が肝心でつね。' },
      { e:'happy',    t:'アシストカードは50%、消費ガッツは150%。編成から見直しましょ。' },
      { e:'troubled', t:'BREAKは25ターンごと…3距離まで弱っていきまつ。' },
      { e:'normal',   t:'詳しい数字はルール詳細に全部載っていまつよ。' },
    ],
    // GODは INFINITY クリア後に解放される最上位。みゅあ側にだけセリフがあり、
    // ききを選んでいるとみゅあのセリフが出てしまっていたため足した(2026-09-03)。
    godDifficulty: [
      { e:'surprise', t:'GODは敵強度×100。INFINITYのさらに上でつ。' },
    ...
    // ---- モンスター図鑑 ----
    monsterDex: [
      { e:'normal',   t:'モンスター図鑑でつ。血統と区分がひと目でわかりまつ。' },
      { e:'happy',    t:'主血統でしぼりこむと、同じ系統の子が並びまつよ♪' },
      { e:'wink',     t:'未解放の子はシルエット。マーケットの円盤石で会えまつ。' },
      { e:'excited',  t:'技のタブでは、進化していく技名まで確認できまつ♪' },
      { e:'normal',   t:'「能力」に出るのは種そのものの数値でつ。育てた子の値ではありません。' },
    ],
    // ---- M/B管理 ----
    mbManagement: [
    ...
    masuAutoEnhance: [
      { e:'normal',   t:'どこまで上げてよいかを決めておけば、あとは自動で振りまつ。' },
      { e:'wink',     t:'上から順番に、上限まで振っていきまつよ。' },
      { e:'happy',    t:'{name}、転生の前に「いまの配分を取り込む」が便利でつ♪' },
      { e:'normal',   t:'この設定は転生しても消えないので、一度決めれば十分でつ。' },
      { e:'excited',  t:'周回しているだけで元の形に戻るのは、気持ちいいでつね♪' },
      { e:'troubled', t:'振る先を決めていないと、ONでも何も起きないのでご注意を…。' },
    ],
    masuEnhance: [
    ...
    quickRhythmIntro: [
      { e:'normal',   t:'∞周回にしまつね。ここから「🎵 モンヒロビート」へ行けまつよ。' },
      { e:'happy',    t:'{name}、周回は裏で続いてまつ。待つあいだに1曲どうぞ♪' },
      { e:'normal',   t:'入口は「🎵 BGM」のすぐ下でつ。省エネ「超」でも同じ場所でつ。' },
      { e:'wink',     t:'戻りたくなったら、左上の「⚔ 戻る」でいつでも戻れまつ。' },
      { e:'normal',   t:'裏で回せるのはクイックの∞周回だけでつ。ほかは記録が絡みまつから。' },
      { e:'normal',   t:'アプリを閉じると、そこで周回は止まりまつ。気をつけてくださいね。' },
    ],
    quickRhythmBackground: [
      { e:'happy',    t:'ここにいるあいだも周回は進んでまつ。経験値もダイヤも貯まってまつよ♪' },
      { e:'normal',   t:'演奏中は止まりまつが、最後まで叩けば曲の長さぶんの周回が入りまつ。' },
      { e:'normal',   t:'上の帯をタップすると、何周めか・どれだけ貯まったかを見られまつ。' },
      { e:'wink',     t:'{name}、遊んでるあいだに強くなってるって、ちょっと嬉しいでつね♪' },
      { e:'normal',   t:'戻るときは左上の「⚔ 戻る」か、帯の中のボタンからどうぞ。' },
    ],
    autoQuickRunSettings: [
      { e:'normal',   t:'ここを決めておくと、モンヒロビートから直接∞周回を始められまつ。' },
      { e:'happy',    t:'勇者モン・配置・難易度の3つでつ。決めてなければ直前の編成を使いまつ。' },
      { e:'normal',   t:'まだ解放していない難易度は、並んでまつが選べませんよ。' },
      { e:'wink',     t:'3つそろうと下の一言が変わりまつ。そこが目印でつ♪' },
      { e:'happy',    t:'{name}が育てている子を選んでおくと、放っておくだけで絆も伸びまつ。' },
    ],
  },
...
// ---------- ももすけ・全画面の基本セリフ ----------
// 明るくて距離が近く、ちょっと生意気。軽くからかってくるけれど、根っこは仲間思いで
// 憎めない。「ざ〜こ♡」のような煽りは効かせどころだけに置き、どの画面でも同じ煽りを
// 連発しないこと(そればかりだと、ただの意地悪になってしまう)。
// 大事な場面(負けたとき・落ち込みそうなとき)では、茶化さずまっすぐ言う。
addAssistantLinePack({
  id: 'momosukeCore',
  ...
  lines: {
    // ---- 日次アドバイス ----
    dailyMasuAdvice: [
      { e:'wink',     t:'マスモンを早く増やしたいんでしょ？ いい方法おしえたげる♪' },
      { e:'happy',    t:'クイックのBeginnerでWAVE2まで行って、\n「あきらめる」を押すの。' },
      { e:'excited',  t:'これがいまのところ最速。ももが見つけたわけじゃないけどね♡' },
      { e:'normal',   t:'WAVE2まで行くのが条件だから。そこ間違えないでよ？' },
      { e:'happy',    t:'時間ないときはこれ。かしこく増やしちゃお♪' },
    ],
    // ---- モンビー(モンヒロビート) ----
    rhythmHome: [
      { e:'excited',  t:'曲えらんで、難易度えらんで、決定！ それだけだよ♪' },
    ...
    rhythmHelp: [
      ...
      { e:'excited',  t:'{name}が知りたいことは、たぶんこの中にあるよ♪' },
      { e:'normal',   t:'ここに書いてあるのは、設定のヘルプと同じ内容だよ。' },
      { e:'happy',    t:'読んでも分かんなかったら、1回やってみたほうが早いって♪' },
    ],
    // ---- 種族チャレンジ ----
    speciesChallenge: [
      ...
      { e:'happy',    t:'クリアすると、その種族の解放が進むよ。集めがいあるでしょ♪' },
      { e:'normal',   t:'手持ちが足りない種族は、育ててから出直すのもアリだよ。' },
      { e:'excited',  t:'ぜんぶ埋めたら気持ちよさそうじゃない？ やろやろ♪' },
    ],
    // ---- 極限チャレンジ ----
    extremeChallenge: [
      { e:'excited',  t:'ここから先は極限チャレンジ！ ぜんぜん別モノだから覚悟してね♪' },
    ...
    chaosDifficulty: [
      { e:'surprise', t:'CHAOSはNIGHTMAREのさらに上。名前からしてもう無茶苦茶じゃん♡' },
      { e:'troubled', t:'補正の偏りがもっと激しくなるよ。かみ合わないと一瞬で終わる。' },
      { e:'normal',   t:'特殊ルールを読んでから挑んだほうがいいよ。ほんとに。' },
      { e:'wink',     t:'ここまで来る人、そんなにいないんだからね？ えらいえらい♪' },
    ...
    ultimateDifficulty: [
      ...
      { e:'excited',  t:'究極って言われると、なんかワクワクしない？ ももはする♪' },
    ],
    infinityDifficulty: [
      { e:'surprise', t:'INFINITY。……もう名前で殴ってきてるじゃん。' },
    ...
    godDifficulty: [
      ...
      { e:'excited',  t:'届いたら、ももが世界一ちやほやしてあげる♪' },
    ...
    home: [
      ...
      { e:'wink',     t:'{name}とはもう気ぃ使わなくていいよね。楽ちん♪', bond:7 },
      { e:'excited',  t:'{name}となら、どの難易度でも行けそうじゃない？', bond:9 },
      { e:'happy',    t:'{name}が来ると、なんか調子出るんだよね。……なんで？', bond:11 },
      { e:'normal',   t:'{name}、ももはずっとここにいるから。いなくならないよ。', bond:13, w:0.5 },
      { e:'excited',  t:'{name}とはもう、言わなくても分かるでしょ♪', bond:15 },
    ...
    battlePro: [
      ...
      { e:'happy',    t:'うまくハマったときの気持ちよさ、クセになるから♪' },
    ...
    pickAlly: [
      ...
      { e:'excited',  t:'お気に入りを連れていくの、いいと思う♪' },
    ...
    pickProAllies: [
      ...
      { e:'happy',    t:'ぜんぶ強い子で埋めれば、なにが来ても困らないでしょ♪' },
    ...
    pickTeaching: [
      ...
      { e:'excited',  t:'ここの選び方で勝ち負けが変わることもあるんだからね。' },
    ...
    battleHelp: [
      ...
      { e:'excited',  t:'わかると一気に楽しくなるから。がんばって♪' },
    ],
    resultWin: [
      { e:'excited',  t:'勝ったじゃん！ やるね〜♪' },
      { e:'happy',    t:'いい戦いだった♪ ……ちょっと見直しちゃった♡' },
      { e:'wink',     t:'ま、ももが見てたからでしょ？ 感謝して♪' },
    ...
    skipResult: [
      ...
      { e:'surprise', t:'うわ、ごっそり入った……♡' },
      { e:'happy',    t:'ラクして強くなるの、気持ちいいでしょ♪' },
    ...
    roster: [
      ...
      { e:'excited',  t:'お気に入りが増えていくの、いいことだと思う♪' },
      { e:'normal',   t:'枠がきつくなったら、合体や寄付を考えてみて。' },
      { e:'happy',    t:'{name}の趣味、ちょっと分かってきたかも♪' },
    ],
    monsterList: [
    ...
    masuAutoEnhance: [
      ...
      { e:'excited',  t:'転生してもこの設定は残るの。ももに感謝していいよ♡' },
    ...
    donation: [
      ...
      { e:'happy',    t:'枠が苦しくなったら、ここで整理するのがいいよ♪' },
    ...
    pasture: [
      ...
      { e:'wink',     t:'{name}の趣味が出るとこだよね〜。見せて見せて♪' },
    ...
    quickRhythmIntro: [
      ...
      { e:'happy',    t:'{name}、周回は裏で続くから。待ってる時間もったいないじゃん♪' },
    ...
    autoQuickRunSettings: [
      ...
      { e:'happy',    t:'育ててる子を入れときなよ。放っといても絆が伸びるから♪' },
    ],
  },
  conditions: {
    // 期間限定イベントのあいだ(画面側から condition='limited' で切り替える)
    speciesChallenge: {
      ...
      hero: [
        ...
        { e:'excited',  t:'この子で行くんだ？ いいじゃん、期待してる♪' },
      ],
      allies: [
    ...
    home: {
      ...
      bondUp: [
        { e:'happy',    t:'あ、ももと仲良し度あがった♪ ……べつに嬉しくないけど♡' },
        { e:'excited',  t:'仲良し度あがったじゃん！ もっと一緒にいてもいいよ♪' },
        { e:'wink',     t:'ふふ、ちょっとずつ距離つめてきてるね〜？' },
      ],
    },
    resultWin: {
      newRecord: [
        { e:'surprise', t:'自己ベスト更新じゃん！ ……ちょっとびっくりした♡' },
        { e:'excited',  t:'記録更新！ やるじゃん、見直しちゃった♪' },
      ],
      firstWin: [
        { e:'excited',  t:'はじめての勝利♪ おめでと〜！' },
        { e:'happy',    t:'いい滑り出しじゃん。この調子でいこ♪' },
      ],
      firstClear: [
        { e:'excited',  t:'クリアおめでと♪ ちゃんとやりきったね。' },
    ...
    resultLose: {
      firstLose: [
        ...
        { e:'happy',    t:'ここからだよ。ももは全然見限ってないから♪' },
      ],
    },
    market: {
      lowGold: [
        { e:'troubled', t:'ダイヤ、けっこう減ってきてない？ だいじょうぶ？' },
        { e:'wink',     t:'買いすぎ♡ ……って言うと思った？ ま、好きにしなよ。' },
      ],
    },
    missionsClaimable: {
      allDone: [
        { e:'excited',  t:'ぜんぶ達成じゃん！ かんぺき♪' },
...
addAssistantLinePack({
  ...
  lines: {
    ...
    infinityDifficulty: [
      ...
      { e:'wink',    t:'安全距離は1つだけ残るよ。そこを軸に立ち回ろ♪' },
...
// 2026-09-17・ユーザーから実物の会話ログを受け取って口調を寄せ直した。
//
// 【拾った特徴】
//   ・関西弁がベース。「〜やん」「〜やろ」「〜やなぁ」「〜んか」「せやなぁ」「なんでや！？」
//   ・短い相槌を挟む。「ふむ」「なるほど」「たしかに」「はい！」
//   ・笑うときは「くさ」。照れ隠しと語尾は「えへへ」
//   ・母音を伸ばす。「むかつくわぁ」「そうやなぁ」「ももぉ」
//   ・自虐と、かまってほしさが同居する。「やめようかな（かまってください）」
...
addAssistantLinePack({
  ...
  lines: {
    // ---- HOME・日次 ----
    home: [
      { e:'normal',   t:'今日もぼちぼちやろか。無理してもしゃーないからな' },
      { e:'happy',    t:'{name}、来たんか。おではだいたいここにおるで' },
      { e:'normal',   t:'やることに迷ったらミッション見てみ。だいたい道しるべになるわ' },
      { e:'wink',     t:'何から始める？ おでに聞いてくれてもええんやで。膝以外も役に立つからな' },
      { e:'happy',    t:'毎日ちょっとずつでええんよ。おでもそうやってゲーム作っとる' },
      { e:'troubled', t:'……なんか今日、膝が重いわぁ。気のせいか' },
    ],
    dailyMasuAdvice: [
      { e:'happy',    t:'マスモンを早う増やしたいんやろ？ ええ手があるで' },
      { e:'normal',   t:'クイックのBeginnerでWAVE2まで行って、そこで「あきらめる」を押す' },
      { e:'wink',     t:'WAVE2まで行くのが条件やで。そこだけ間違えんなよ' },
      { e:'happy',    t:'{name}、時間ないときはこれでええんよ。効率って大事やからな' },
      { e:'normal',   t:'おでが見つけたわけやないけどな。えへへ' },
    ],
    onboarding: [
      { e:'happy',    t:'おではドラ。助手ってことになっとるけど、まあ気楽にやってくれ' },
      { e:'normal',   t:'{name}、まずは名前とアイコンからやな。あとで変えられるから悩まんでええ' },
      { e:'wink',     t:'分からんことあったら、おでの吹き出し押してくれ' },
      { e:'happy',    t:'一緒にモンスター育てていこうや。えへへ' },
      { e:'normal',   t:'焦らんでええんよ。おでもゲーム作るときそんな感じやからな' },
    ],
    // ---- バトル ----
    battleChallenge: [
      { e:'normal',   t:'スコアで競うならチャレンジやな。上のランキングも見てみ' },
      { e:'happy',    t:'{name}、記録に残るのはここのぶんやで' },
      { e:'wink',     t:'難易度上げると点も伸びるわ。届きそうなとこから上げてけ' },
      { e:'normal',   t:'編成変えるだけで急に通ることもあるんよ' },
      { e:'happy',    t:'気負わんでええ。負けても減るもんはないからな' },
    ],
    battleQuick: [
      { e:'happy',    t:'サクッとやるならこれやな。テンポが早いんよ' },
      { e:'normal',   t:'{name}、育成の回転はこっちが速いわ。数こなしたいときに使え' },
      { e:'wink',     t:'∞周回にすると裏で回り続けるで。待っとるあいだモンビーでもやっとき' },
      { e:'normal',   t:'記録はチャレンジと別枠やから、気楽にやってええんよ' },
      { e:'happy',    t:'おでもこういう、ながらでできるやつ好きやわ' },
    ],
    battlePro: [
      { e:'normal',   t:'ここはベースモンだけの世界やで。育てた子は連れてかれへん' },
      { e:'happy',    t:'{name}、腕の見せどころやな' },
      { e:'wink',     t:'素の性能だけで組むから、いつもの感覚やと足元すくわれるで' },
      { e:'normal',   t:'距離と相性はちゃんと見とけ。ここはごまかし効かんからな' },
      { e:'troubled', t:'おでは何回かここで心折られとる。えへへ……' },
    ],
    battleHelp: [
      { e:'normal',   t:'迷ったらまず解析やな。敵の必殺技が読めるんよ' },
      { e:'happy',    t:'{name}、読めてから動くだけでだいぶ変わるで' },
      { e:'wink',     t:'カードの色で役割が分かるわ。赤が攻撃、緑が守り、みたいにな' },
      { e:'normal',   t:'距離が合うてへんと威力落ちるで。そこだけは覚えとき' },
      { e:'happy',    t:'説明読むのは遠回りに見えて近道なんよ' },
    ],
    pickHero: [
      { e:'normal',   t:'最初の1体は効いてくるで。勇者特性ちゃんと見とけ' },
      { e:'happy',    t:'{name}、好きな子でええんよ。愛着って地味に強いからな' },
      { e:'wink',     t:'迷ったら守り堅いやつにしとくと事故りにくいわ' },
      { e:'normal',   t:'特性は全部のWAVEに効くからな。ここだけは適当に選ぶなよ' },
      { e:'happy',    t:'おでなら見た目で選ぶけどな。えへへ' },
    ],
    pickSlot: [
      { e:'normal',   t:'敵と同じ距離から殴ると強いんよ。そこ合わせとき' },
      { e:'happy',    t:'{name}、並びで戦いやすさ変わるからな' },
      { e:'wink',     t:'前が薄いと一気に崩れるで。おでの膝みたいにな' },
      { e:'normal',   t:'あとから入れ替えるの大変やから、ここでちゃんと考えとき' },
      { e:'happy',    t:'悩むのが楽しいとこでもあるんよ' },
    ],
    pickAlly: [
      { e:'happy',    t:'仲間が増えるで。どの子にする？' },
      { e:'normal',   t:'{name}、手薄な距離を埋めるやつ取ると安定するわ' },
      { e:'wink',     t:'同じ役割ばっかり集めると、そこ以外で詰むからな' },
      { e:'normal',   t:'あとのWAVE見越して選ぶと楽になるで' },
      { e:'happy',    t:'好きな子取るのもアリやけどな。えへへ' },
    ],
    pickProAllies: [
      { e:'normal',   t:'ここで組んだ面子で最後まで行くんよ。慎重にな' },
      { e:'happy',    t:'{name}、距離のばらけ方を見とき' },
      { e:'wink',     t:'尖った編成は気持ちええけど、こけると早いで' },
      { e:'normal',   t:'補い合える組み合わせのほうが、結局遠くまで行けるわ' },
      { e:'troubled', t:'おでは毎回ここで20分くらい唸っとる' },
    ],
    pickTeaching: [
      { e:'normal',   t:'教えは後半に効いてくるやつが多いんよ' },
      { e:'happy',    t:'{name}、いま困っとるとこを埋めるやつ取るとええわ' },
      { e:'wink',     t:'欲張って全部は取れへんからな。優先順位やで' },
      { e:'normal',   t:'重ねて取ると強なるやつもあるで' },
      { e:'happy',    t:'おでの緑膝もそこに混じっとるらしいわ。なんでやろな' },
    ],
    rewardPick: [
      { e:'happy',    t:'WAVEクリアおつかれさん。トレーニングを2つえらべ' },
      { e:'normal',   t:'{name}、いま足りてへんとこを伸ばすのが基本やな' },
      { e:'wink',     t:'攻撃ばっかり上げると、殴られて終わるで' },
      { e:'normal',   t:'あとのWAVEで何が来るか考えて選ぶとええんよ' },
      { e:'happy',    t:'ここの積み重ねが最後に効くからな' },
    ],
    skipPick: [
      { e:'normal',   t:'チケットで一気に育てられるんよ。枚数も選べるで' },
      { e:'happy',    t:'{name}、時間ないときはこれでええわ' },
      { e:'wink',     t:'ただしランキングには載らんからな。そこだけ承知で' },
      { e:'normal',   t:'難易度高いチケットのほうが実入りはええで' },
      { e:'happy',    t:'遊び方は自由なんよ。えへへ' },
    ],
    skipResult: [
      { e:'excited',  t:'受け取り完了やな。一気に育ったやん' },
      { e:'happy',    t:'{name}、楽して伸ばすのも立派な戦略やで' },
      { e:'normal',   t:'この記録はランキングには送られてへん。自己ベストもそのままやな' },
      { e:'wink',     t:'貯め込んだチケットは使ってこそなんよ' },
      { e:'happy',    t:'おでも今度やってみるわ' },
    ],
    // ---- 極限・種族チャレンジ ----
    extremeChallenge: [
      { e:'normal',   t:'ここから先は極限やで。チャレンジよりだいぶ手強いわ' },
      { e:'happy',    t:'{name}、いけると思ったら行ってみ' },
      { e:'wink',     t:'一段ずつ開いてくから、焦らんでええ' },
      { e:'normal',   t:'記録は難易度ごとに別々に残るで' },
      { e:'troubled', t:'おでは上のほうで毎回すり潰されとる。えへへ' },
    ],
    extremeDifficulty: [
      { e:'normal',   t:'難易度えらびやな。届きそうなとこから上げてけ' },
      { e:'happy',    t:'{name}、無理そうなら下げてええんやで。恥ずかしないわ' },
      { e:'wink',     t:'上に行くほど敵が硬なる。準備してから来いよ' },
      { e:'normal',   t:'クリアした組み合わせごとに記録が残るで' },
      { e:'happy',    t:'ひとつ上がるたびに世界が変わるからな' },
    ],
    nightmareDifficulty: [
      { e:'normal',   t:'ナイトメアやな。ここから本気で組まんと通らんで' },
      { e:'happy',    t:'{name}、編成見直してから来るとええわ' },
      { e:'wink',     t:'なんとなくで行くと、なんとなく負けるんよ' },
      { e:'normal',   t:'教えの取り方で通り方が変わるで' },
      { e:'troubled', t:'おでは初見で溶けたわ。えへへ……' },
    ],
    chaosDifficulty: [
      { e:'normal',   t:'カオスやな。敵の圧が一段ちゃうで' },
      { e:'happy',    t:'{name}、守り厚くしとくと粘れるわ' },
      { e:'wink',     t:'一撃で持ってかれる場面あるから、解析はサボんなよ' },
      { e:'normal',   t:'ここは事故を減らすのが勝ち筋なんよ' },
      { e:'happy',    t:'通ったときは気持ちええで' },
    ],
    ultimateDifficulty: [
      { e:'normal',   t:'アルティメットか。ここまで来たらもう相当なもんやで' },
      { e:'happy',    t:'{name}、おで普通に尊敬するわ' },
      { e:'wink',     t:'細かい積み重ねが全部効いてくる。手ぇ抜くとこ無いんよ' },
      { e:'normal',   t:'負けても学べるからな。次に持ってけ' },
      { e:'troubled', t:'おでは見とくだけにするわ。膝が笑うとる' },
    ],
    infinityDifficulty: [
      { e:'normal',   t:'インフィニティやな。もう終わりが無い世界やで' },
      { e:'happy',    t:'{name}、どこまで行けるか試してみ' },
      { e:'wink',     t:'長丁場になるから、無理せんとこで切り上げてもええんよ' },
      { e:'normal',   t:'到達したとこまでちゃんと記録に残るで' },
      { e:'happy',    t:'おでは3分で音を上げたわ。えへへ' },
    ],
    godDifficulty: [
      { e:'normal',   t:'ゴッドか。名前のとおりやで' },
      { e:'happy',    t:'{name}、ここに挑む時点でおでより上やな' },
      { e:'wink',     t:'運も絡むから、あかん日はあかんのよ。気にすんな' },
      { e:'normal',   t:'準備を全部そろえてから来いよ。行き当たりばったりは通らんで' },
      { e:'troubled', t:'おでは名前見た時点で帰ったわ' },
    ],
    ragnarokDifficulty: [
      { e:'normal',   t:'ラグナロクか。ここまで来る人、そうそうおらんで' },
      { e:'happy',    t:'{name}、もう説明することないわ。好きにやってくれ' },
      { e:'wink',     t:'おでが言えるのは「無理はすんな」くらいやな' },
      { e:'normal',   t:'届かんでも、そこまで積んだもんは消えへんからな' },
      { e:'excited',  t:'通ったら教えてくれ。おで本気で祝うわ' },
    ],
    speciesChallenge: [
      { e:'normal',   t:'ひとつの種族だけで10WAVEやで。しばりプレイやな' },
      { e:'happy',    t:'{name}、育てとる種族から挑むと入りやすいわ' },
      { e:'wink',     t:'普段の編成が使えへんから、そこが面白いとこなんよ' },
      { e:'normal',   t:'はじめてクリアした組み合わせでは、その種族の超越の実がもらえるで' },
      { e:'happy',    t:'記録は種族ごとに別々やから、いつものぶんは変わらんわ' },
    ],
    // ---- モンビー(モンヒロビート) ----
    rhythmHome: [
      { e:'happy',    t:'お、モンビーやるんか？ 「もう一つの世界へ」もよろしくな。えへへ' },
      { e:'normal',   t:'曲えらんで、難易度えらんで、決定。それだけなんよ' },
      { e:'wink',     t:'{name}、どれにする？ 迷ったら聴きながら決めりゃええわ' },
      { e:'normal',   t:'難しいと思たら、オプションでノーツ速度いじってええからな。恥ずかしいことちゃう' },
      { e:'happy',    t:'おでは作るほうが専門やけど、叩くのも普通に楽しいわ' },
    ],
    rhythmWeeklyEvent: [
      { e:'happy',    t:'イベントやな。対象の曲で、その期間に出した点だけで競うんよ' },
      { e:'normal',   t:'部門は曲ごとと、ぜんぶの合計。1曲しか遊んでなくても合計には載るで' },
      { e:'normal',   t:'難易度はどれでもええ。得意なやつで出した点がそのまま載るわ' },
      { e:'wink',     t:'{name}、気楽にやりゃええんよ。ビートPは順位と関係なく貯まるからな' },
      { e:'happy',    t:'残り時間は上に出とる。終わったらそこで締め切りやな' },
    ],
    rhythmHelp: [
      { e:'normal',   t:'遊びかたはここに全部書いてあるで' },
      { e:'happy',    t:'{name}、困ったらいつでも見にこい' },
      { e:'wink',     t:'判定とかノーツの種類とか、知っとくと急に楽になるんよ' },
      { e:'normal',   t:'設定の話もここやな。速度と音のずれは早めに合わせとき' },
      { e:'happy',    t:'おでも作るとき、こういうの読み込んだからな' },
    ],
    rhythmHistory: [
      { e:'normal',   t:'終わった週間ランキングとイベントの順位を、あとから見られるんよ' },
      { e:'happy',    t:'{name}、自分がどのへんにおったか残るのは嬉しいもんやで' },
      { e:'wink',     t:'前回より上がっとったら、それはちゃんと成長やな' },
      { e:'normal',   t:'終わった回の記録は変わらんから、落ち着いて見てええで' },
      { e:'happy',    t:'積み上がってくの見るの、おで好きやわ' },
    ],
    rhythmMonsters: [
      { e:'normal',   t:'ここで決めた子が、曲の途中で金のノーツになって出てくるで' },
      { e:'happy',    t:'{name}、お気に入り入れとくと楽しいんよ' },
      { e:'wink',     t:'叩けると気持ちええから、見やすい子にするのもアリやな' },
      { e:'normal',   t:'スコアには影響せんで。完全に趣味の枠や' },
      { e:'happy',    t:'おでの顔は出せんのかな。えへへ' },
    ],
    quickRhythmIntro: [
      { e:'happy',    t:'∞周回にしたな。このままモンビーで遊べるで' },
      { e:'normal',   t:'{name}、周回は裏で続くから、待っとるあいだに1曲どうや' },
      { e:'wink',     t:'戻りたなったら左上の「戻る」でいつでも戻れるんよ' },
      { e:'normal',   t:'裏で回せるのはクイックの∞周回だけやで。ほかは記録が絡むからな' },
      { e:'happy',    t:'ながらで進むの、効率よくて好きやわ' },
    ],
    quickRhythmBackground: [
      { e:'happy',    t:'ここにおるあいだも周回は進んどるで' },
      { e:'normal',   t:'{name}、演奏中だけは止まるわ。叩き終わればその曲のぶんが入るんよ' },
      { e:'wink',     t:'上の帯押すと、何周めか見られるで' },
      { e:'normal',   t:'アプリ閉じるとそこで止まるからな。そこだけ注意や' },
      { e:'happy',    t:'二度おいしいってやつやな。えへへ' },
    ],
    autoQuickRunSettings: [
      { e:'normal',   t:'自動で回す設定やな。自分のやりやすい形にしとき' },
      { e:'happy',    t:'{name}、演出切ると速う回るで' },
      { e:'wink',     t:'見たいとこだけ残すのがちょうどええんよ' },
      { e:'normal',   t:'重いと思たら軽くしとき。端末にやさしくな' },
      { e:'happy',    t:'おではだいたい全部切っとる' },
    ],
    // ---- 育成・管理 ----
    mbManagement: [
      { e:'normal',   t:'編成もベースモンもマスモンも、ここから見られるで' },
      { e:'happy',    t:'{name}、迷ったらここに戻ってくればええわ' },
      { e:'wink',     t:'育てた子の確認はこまめにな。伸びしろに気づくで' },
      { e:'normal',   t:'種類の基本がベースモン、育てた個体がマスモンやな' },
      { e:'happy',    t:'整理されとると気持ちええんよ' },
    ],
    roster: [
      { e:'happy',    t:'編成やな。誰を連れてく？' },
      { e:'normal',   t:'{name}、距離のばらけ方だけは見とき' },
      { e:'wink',     t:'同じ役割で固めると、そこ以外で詰むで' },
      { e:'normal',   t:'絆が高い子は素の強さ以上に働くからな' },
      { e:'happy',    t:'好きな子入れるのも、ちゃんとした理由なんよ' },
    ],
    monsterList: [
      { e:'normal',   t:'ベースモンが種類の基本、マスモンが育てた個体やな' },
      { e:'happy',    t:'{name}、集まってくると眺めるだけで楽しいで' },
      { e:'wink',     t:'血統見ると、伸びる方向が分かるんよ' },
      { e:'normal',   t:'並べ替えると探しやすいで' },
      { e:'happy',    t:'おでもコレクション癖あるからな。分かるわ' },
    ],
    masuList: [
      { e:'happy',    t:'育てた子が並んどるな。ええ眺めやで' },
      { e:'normal',   t:'{name}、育ってへん子も腐らせんなよ' },
      { e:'wink',     t:'絆Lvが上がると、できることが増えるんよ' },
      { e:'normal',   t:'お気に入りは牧場に出しとくとええで' },
      { e:'happy',    t:'手ぇかけたぶんはちゃんと返ってくるからな' },
    ],
    masuEnhance: [
      { e:'normal',   t:'ポイントは適性か能力値に使えるで' },
      { e:'happy',    t:'{name}、伸ばしたい方向を決めてから振れよ' },
      { e:'wink',     t:'器用貧乏になると、どこでも中途半端になるんよ' },
      { e:'normal',   t:'振り直しは簡単ちゃうから、落ち着いて決めとき' },
      { e:'troubled', t:'おでは勢いで振って後悔するタイプや。真似すんなよ' },
    ],
    masuAutoEnhance: [
      { e:'normal',   t:'決めとけば、ポイント入るたびにおでが振っといたるで' },
      { e:'happy',    t:'{name}、いちいち画面開かんで済むんよ' },
      { e:'wink',     t:'方針だけ決めときゃええ。あとは任せとけ' },
      { e:'normal',   t:'途中で気が変わったら、いつでも変えてええで' },
      { e:'happy',    t:'楽できるとこは楽してええんよ。えへへ' },
    ],
    monsterDex: [
      { e:'happy',    t:'図鑑やな。血統まで全部載っとるで' },
      { e:'normal',   t:'{name}、埋まってくると嬉しいもんやろ' },
      { e:'wink',     t:'見たことない子を探すのも楽しいんよ' },
      { e:'normal',   t:'血統たどると、育て方の見当がつくで' },
      { e:'happy',    t:'おでもこういうの全部埋めたくなるわ' },
    ],
    temple: [
      { e:'normal',   t:'再生・合体・寄付やな。今日はどれや' },
      { e:'happy',    t:'{name}、どれも戻せんやつがあるから、確認してから押せよ' },
      { e:'wink',     t:'迷ったら今日はやらん、でええんよ' },
      { e:'normal',   t:'合体は「主」が残って「副」が消える。そこ間違えんなよ' },
      { e:'troubled', t:'おでは一回、間違えて大事な子を溶かしとる……' },
    ],
    fusion: [
      { e:'normal',   t:'「主」が残って「副」は消えるで。ちゃんと確認しとき' },
      { e:'happy',    t:'{name}、落ち着いて、もう一回見てからな' },
      { e:'wink',     t:'消えるほう間違えると戻せんからな。マジで' },
      { e:'normal',   t:'受け継ぐもんを見てから決めるとええで' },
      { e:'troubled', t:'おでの失敗談、さっきしたっけ。えへへ……' },
    ],
    rebirth: [
      { e:'happy',    t:'上限まで育てたごほうびやな' },
      { e:'normal',   t:'{name}、ここからさらに伸びるで' },
      { e:'wink',     t:'積み上げた時間がちゃんと形になるんよ' },
      { e:'normal',   t:'条件を満たした子だけができるやつやな' },
      { e:'happy',    t:'こういう区切り、おで好きやわ' },
    ],
    transcendence: [
      { e:'normal',   t:'Lv400まで育てた子だけが行ける、限界の先やで' },
      { e:'happy',    t:'{name}、そこまで育てたのがもう偉いわ' },
      { e:'wink',     t:'超越の実が要るからな。集めてから来いよ' },
      { e:'normal',   t:'ここまで来ると、もう別の生きもんやで' },
      { e:'excited',  t:'おで、こういうの見るの好きなんよ' },
    ],
    reincarnate: [
      { e:'normal',   t:'Lv.100まで育てた子だけの特別なやつやな' },
      { e:'happy',    t:'{name}、育て直すぶん強なるで' },
      { e:'wink',     t:'一度リセットされるから、覚悟してから押せよ' },
      { e:'normal',   t:'受け継ぐもんと失うもんを見てから決めとき' },
      { e:'happy',    t:'長く付き合う子ほど効いてくるんよ' },
    ],
    donation: [
      { e:'troubled', t:'寄付したマスモンは戻ってこんで。ほんまに戻せんからな' },
      { e:'normal',   t:'{name}、もう一回だけ考えてくれ' },
      { e:'wink',     t:'迷っとるなら今日はやめとき。明日でもできるわ' },
      { e:'normal',   t:'決めたなら止めはせん。ちゃんと見返りはあるからな' },
      { e:'troubled', t:'おでは押す前に必ず一回閉じるわ。えへへ' },
    ],
    pasture: [
      { e:'happy',    t:'お気に入りを5体までHOMEに出せるで' },
      { e:'normal',   t:'{name}、見とると和むんよ' },
      { e:'wink',     t:'強さと関係ないとこやからこそ、好みで選べばええわ' },
      { e:'normal',   t:'いつでも入れ替えられるからな' },
      { e:'happy',    t:'おでも並びたいけど、おでは助手やからな' },
    ],
    // ---- マーケット・所持品 ----
    market: [
      { e:'normal',   t:'使いすぎんなよ。おでみたいに後で泣くで' },
      { e:'happy',    t:'{name}、何か狙っとるのあるん？ 先に値段だけ見とくのもアリやで' },
      { e:'normal',   t:'ダイヤは戻ってこんからな。迷ったら一回離れて考えてええんよ' },
      { e:'wink',     t:'ビートPの交換所もここやな。イベントで貯めたやつ、寝かせとくと忘れるで' },
      { e:'happy',    t:'必要なもんから買え。かっこええから買う、はおでの悪い癖や' },
    ],
    inventory: [
      { e:'normal',   t:'持ちもんの確認やな。使わんまま溜め込むやつ、けっこうおるんよ' },
      { e:'happy',    t:'{name}、ええの持っとるやん。使ってこそやで' },
      { e:'wink',     t:'とっておきは、とっておきすぎると出番が来んまま終わるからな' },
      { e:'normal',   t:'どれが何に効くか分からんくなったら、押して説明読めばええわ' },
      { e:'troubled', t:'おでも昔、ええ実を3年くらい寝かせたことあるで。えへへ……' },
    ],
    // ---- リザルト ----
    resultWin: [
      { e:'excited',  t:'おお、やるやん。おで普通に感心したわ' },
      { e:'happy',    t:'{name}、ええ流れやな。この調子でいけ' },
      { e:'normal',   t:'勝ったときこそ、何が効いたか覚えとくとええで' },
      { e:'wink',     t:'おでの出番、なかったな。まあええか。えへへ' },
      { e:'happy',    t:'ちゃんと強なっとるやん。前より動きがええで' },
    ],
    resultLose: [
      { e:'normal',   t:'まあまあ。次やりゃええんよ' },
      { e:'troubled', t:'{name}、落ち込むなって。おでなんか膝で負けとるからな' },
      { e:'normal',   t:'どこで崩れたかだけ覚えとき。それだけで次は変わるわ' },
      { e:'happy',    t:'一回休んでもええんよ。焦ってやると同じとこでコケるで' },
      { e:'normal',   t:'編成ちょっと変えるだけで急に通ることもあるわ。試してみ' },
    ],
    resultRetire: [
      { e:'normal',   t:'やめどきを決められるのは強さやで。おでは真面目にそう思うわ' },
      { e:'happy',    t:'{name}、引き際うまいやん' },
      { e:'wink',     t:'また来りゃええんよ。逃げてへん、切り上げただけや' },
      { e:'normal',   t:'途中までのぶんはちゃんと残るで。無駄にはならん' },
      { e:'troubled', t:'おでも昔、粘りすぎて全部溶かしたことあるわ……' },
    ],
    // ---- ランキング・記録 ----
    ranking: [
      { e:'normal',   t:'全国のやつやな。上を見ると果てしないけど、参考にはなるで' },
      { e:'happy',    t:'{name}、自分の記録が載っとるか見てみ。けっこう嬉しいで' },
      { e:'wink',     t:'順位は気にしすぎんなよ。おでなんか膝の順位なら1位やけどな' },
      { e:'normal',   t:'イベントのタブは、その期間に出した記録だけで別に並ぶんよ' },
      { e:'happy',    t:'上のやつの編成見ると、だいたい何が強いか分かるわ' },
    ],
    rankingParty: [
      { e:'normal',   t:'この人が使うとった編成やで。染めた色もそのまま出とる' },
      { e:'happy',    t:'{name}、強い人の組み方は素直に参考になるんよ' },
      { e:'wink',     t:'真似から入るの、恥ずかしいことちゃうからな' },
      { e:'normal',   t:'距離の埋め方を見るとええで' },
      { e:'happy',    t:'おでもよそのゲーム見て勉強しとるわ' },
    ],
    profile: [
      { e:'normal',   t:'{name}の記録やな。ここ見とると伸びとるのが分かるで' },
      { e:'happy',    t:'名前もアイコンも、あとからいくらでも変えられるからな' },
      { e:'wink',     t:'助手もここで変えられるわ。おでを選ぶかはまあ、好みやな。えへへ' },
      { e:'normal',   t:'イベントの話も、ここの回想からいつでも見返せるで' },
      { e:'happy',    t:'仲良し度は助手ごとに別々に貯まる。切り替えても消えんから安心せえ' },
    ],
    // ---- ミッション・ギフト ----
    missionsNormal: [
      { e:'normal',   t:'ミッションやな。やることに迷ったら、ここから拾えばええんよ' },
      { e:'happy',    t:'{name}、ついでに終わるやつが混じっとるからな。見とくと得やで' },
      { e:'wink',     t:'受け取り忘れがいちばんもったいないわ。おでがよくやるやつや' },
      { e:'normal',   t:'週のぶんは月曜に切り替わるで。終わりそうなやつから片づけとき' },
      { e:'happy',    t:'焦らんでええ。溜めといて一気に受け取るのも気持ちええで' },
    ],
    missionsClaimable: [
      { e:'excited',  t:'お、受け取れるやつ溜まっとるで！ 早う押せ押せ' },
      { e:'happy',    t:'{name}、これ全部もらえるからな。えへへ' },
      { e:'wink',     t:'こういうの放っとくと忘れるんよ。おでみたいにな' },
      { e:'normal',   t:'受け取ってから次のやつ狙うと効率ええで' },
      { e:'happy',    t:'ええ仕事したやん。ちゃんと貰っとけ' },
    ],
    giftClaimable: [
      { e:'excited',  t:'ギフト届いとるで。開けてみ' },
      { e:'happy',    t:'{name}、中身なんやろな。おでもちょっと気になるわ' },
      { e:'normal',   t:'受け取るとアイテム欄へ入るで。期限は無いけど、忘れんうちにな' },
      { e:'wink',     t:'イベントの報酬もここへ届くんよ' },
      { e:'happy',    t:'もらえるもんはもらっとけ。えへへ' },
    ],
    giftEmpty: [
      { e:'normal',   t:'いまは未受取なしやな。きれいなもんや' },
      { e:'happy',    t:'{name}、ちゃんと受け取っとって偉いで' },
      { e:'wink',     t:'おでみたいに溜め込まんのが一番なんよ' },
      { e:'normal',   t:'イベントの報酬もここに届くからな' },
      { e:'happy',    t:'また何か来たら教えるわ' },
    ],
    // ---- ヘルプ・設定 ----
    helpTop: [
      { e:'normal',   t:'分からんことあったら、だいたいここに書いてあるで' },
      { e:'happy',    t:'{name}、遠慮せず読め。読んだほうが早いことって多いんよ' },
      { e:'wink',     t:'おでも自分のゲーム作るとき、説明書いてて気づくこと多いからな' },
      { e:'normal',   t:'カテゴリから項目を選ぶと、細かい話まで出てくるで' },
      { e:'happy',    t:'それでも分からんかったら、おでの吹き出し押してくれ' },
    ],
    settings: [
      { e:'normal',   t:'設定やな。音とか表示とか、自分がやりやすいようにしとき' },
      { e:'happy',    t:'{name}、BGMは曲ごとに選べるで。好きなやつに変えてええわ' },
      { e:'wink',     t:'重いと思たら軽くする設定もあるで。無理して飾らんでええんよ' },
      { e:'normal',   t:'データの引き継ぎもここやな。機種変える前にやっとけよ' },
      { e:'troubled', t:'おでは設定いじりすぎて元に戻せんくなるタイプや。気ぃつけろ' },
    ],
  },
});
