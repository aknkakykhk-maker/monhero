...
// β公開に合わせて1度だけ流す導入。「今までのバトルと何が違うか」を、遊ぶ前に3つだけ伝える。
//   ① ライフもちからも1体ずつ持つ(クラシックはパーティ全員の合計)
//   ② 間合いがある(零・近・中・遠)
//   ③ 敵は技を1ターン前に予告する。ガードが効かない技もあるので、受け方を選ぶ
// ★ここへ数字(倍率・確率)を書かない。調整のたびに会話が嘘になる。
//   数字はヘルプとSCAN画面が実データから出す
const ASSISTANT_TACTICS_INTRO = [
  { who:'mua',      e:'excited',  t:'ねぇ聞いて！ バトルに新しい仕組みが来たんだって！' },
  { who:'kiki',     e:'happy',    t:'タクティクスバトル、でつね。今までのバトルとは考え方がまるで違いまつ♪' },
  { who:'momosuke', e:'normal',   t:'ふーん？ どうせ殴り合うだけじゃないの〜。' },
  { who:'dra',      e:'wink',     t:'それが違うんだよ。まず、ライフもちからも1体ずつ持ってる' },
  { who:'mua',      e:'surprise', t:'えっ、みんなの合計じゃないの！？' },
  { who:'dra',      e:'normal',   t:'そう。だから誰が狙われてるかで、守る子も変わってくるんよ' },
  { who:'kiki',     e:'normal',   t:'それに、敵との間合いもありまつ。零・近・中・遠の4つでつね。' },
  { who:'momosuke', e:'surprise', t:'えっ、下がったり近づいたりできるんだ。……ちょっと面白いかも。' },
  { who:'dra',      e:'happy',    t:'敵は技を1ターン前に予告してくる。それを見てから受け方を決めるんだ' },
  { who:'mua',      e:'troubled', t:'予告されるなら、ぜんぶガードすればよくない？' },
  { who:'dra',      e:'troubled', t:'そこなんよ。ガードが効かない技もあるからな。そういうのは間合いをずらすか、避けるか、返すかだ' },
  { who:'kiki',     e:'happy',    t:'だから「次に何が来るか」を読むのが、このバトルのいちばん楽しいところでつ♪' },
  { who:'momosuke', e:'excited',  t:'ふふん、ももなら全部読めちゃうし♡ ……たぶん。' },
  { who:'kiki',     e:'wink',     t:'いまはプロモードだけお試しで開いていまつ。残りは順番に増やしていきますね。' },
  { who:'mua',      e:'excited',  t:'よーし、さっそく行ってみよ♪ 間合いを読んで、勝ちに行こ！' },
];
...
const EVENT_REPLAYS = [
  ...
  { id: 'tactics_intro', title: 'タクティクスバトル ～間合いを読む戦い～', script: ASSISTANT_TACTICS_INTRO, unlockedKey: 'tacticsIntroSeen', releaseFlag: 'tacticsBattle', alwaysUnlocked: true },
