...
const ASSISTANT_SCENES = {
  ...
  // 下の battleQuick とは同じ場所で入れ替わるので、行数が変わって吹き出しの大きさが
  // モードごとに違って見えないよう、文字数をおおよそそろえておく
  battleChallenge: {
    short: 'ランキングを狙うならチャレンジモード！強化フェーズを活かしながら、自己ベスト更新を目指そう♪',
    help: 'basics/battle-modes',
  },
  // バトルメニュー: クイックモードを選んでいるとき(文字数は battleChallenge に合わせる)
  battleQuick: {
    short: 'テンポよく育てるならクイックモード！WAVEごとに自動で強くなるけど、強化内容は選べないよ♪',
    help: 'basics/battle-modes',
  },
  // ヘルプのカテゴリ一覧で話す内容
  helpTop: {
