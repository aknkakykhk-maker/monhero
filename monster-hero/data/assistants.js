...
const ASSISTANT_BEAT_POINT_ALWAYS = [
  ...
  { who:'kiki',     e:'normal',   t:'たしかに、イベントのない週は交換所を眺めるだけになっていましたね' },
  // 知らせ: ももすけから
  ...
  { who:'kiki',     e:'normal',   t:'モンヒロビートを、ですね。最後まで遊べば、どの公開曲でも貯まるんですか？' },
  ...
  { who:'kiki',     e:'happy',    t:'イベント中の貯まり方はこれまでと同じなんですね。対象曲の1.5倍もそのままです' },
  { who:'mua',      e:'normal',   t:'そっか。ふだんはコツコツ、イベントのときはガッツリってことね' },
  { who:'dra',      e:'happy',    t:'コツコツでも、ゼロよりずっといいぞ。おで、毎日叩く' },
  { who:'kiki',     e:'normal',   t:'スコアが高いほど多くもらえるのも、イベント中と同じです' },
  // 予告: 交換所のこれから
  ...
  { who:'kiki',     e:'troubled', t:'みゅあ……アシストカードの略です' },
  ...
  { who:'kiki',     e:'normal',   t:'それまでに貯めておいた分は、そのまま使えます。消えたりしません' },
  // 締め
  ...
  { who:'kiki',     e:'happy',    t:'{name}、交換所に何が並ぶか、一緒に楽しみに待ちましょう' },
  { who:'dra',      e:'happy',    t:'{name}、並んだらちゃんと知らせるからな。えへへ' },
];
const ASSISTANT_BEAT_POINT_ALWAYS_CALLS = { mua: 'もも／ドラケン', kiki: 'ももさん／ドラさん', momosuke: 'ドラちゃん', dra: 'みゅあ／もも' };
