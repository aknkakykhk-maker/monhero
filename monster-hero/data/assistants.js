...
const ASSISTANT_BATTLE_TUTORIAL_BODY = [
  ...
  // ⑦ 技変更
  { id:'skillTalk',    at:'BATTLE',        e:'normal',  title:'技は変えられる', t:'攻撃カードの下のほうに「⇄技変更」って帯があるでしょ？ そこを押すと技を選び直せるの。', spot:'cards', wait:'next' },
  { id:'skillPoint',   at:'BATTLE',        e:'wink',    title:'ここが技変更', t:'光ってる攻撃カードの、ガッツのすぐ上にある帯だよ♪', spot:'cards', wait:'next', needCard:'atk' },
  { id:'skillTwice',   at:'BATTLE',        e:'normal',  title:'名前は押しても大丈夫', t:'絵や技の名前を押したときは、カードを選ぶだけ。一覧は帯を押したときだけ開くよ。', spot:'cards', wait:'next', needCard:'atk' },
...
const ASSISTANT_BATTLE_TUTORIAL_TACTICS_BODY = [
  ...
  // ⑦ 技変更
  { id:'tSkillTalk',   at:'BATTLE',        e:'normal',  title:'技は変えられる', t:'攻撃カードの下のほうに「⇄技変更」って帯があるでしょ？ そこを押すと技を選び直せるの。', spot:'cards', wait:'next' },
  { id:'tSkillPoint',  at:'BATTLE',        e:'wink',    title:'ここが技変更', t:'光ってる攻撃カードの、ガッツのすぐ上にある帯だよ♪', spot:'cards', wait:'next', needCard:'atk' },
  { id:'tSkillTwice',  at:'BATTLE',        e:'normal',  title:'名前は押しても大丈夫', t:'絵や技の名前を押したときは、カードを選ぶだけ。一覧は帯を押したときだけ開くよ。', spot:'cards', wait:'next', needCard:'atk' },
