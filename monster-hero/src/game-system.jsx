  ...
  return ENEMY_ACTION_DEFINITIONS.map(def => {
    ...
    if (available) {
      if (charging) {
        ...
        if (movedLast) { available=false; reason='移動した次のターンは移動しません'; }
