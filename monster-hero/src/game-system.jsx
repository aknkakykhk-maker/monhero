...
const ENEMY_ART_SCALE = { Moo: 2 };
const enemyArtStyle = (enemyId) => ({ transform:`scale(${ENEMY_ART_SCALE[enemyId] || 1})`, transformOrigin:'center' });
