...
const BATTLE_SYSTEMS = Object.freeze([
  Object.freeze({
    ...
    highlights: Object.freeze([
      Object.freeze(['🛡️', 'パーティで1本のライフを分け合う']),
  ...
  Object.freeze({
    ...
    highlights: Object.freeze([
      Object.freeze(['❤️', 'ライフはモンスター1体ずつで持つ']),
      Object.freeze(['🎯', '敵の予告に「誰を狙うか」まで出る']),
      Object.freeze(['🌀', '薙ぎ払いや貫通撃など、敵の技が増える']),
    ]),
    note: 'タクティクスチャレンジ／種族チャレンジ／プロ。難易度は通常と極限から選べます',
    points: Object.freeze([
      Object.freeze(['❤️', 'ライフの持ち方', '基本のバトルはパーティで1本のライフを分け合いますが、こちらはモンスター1体ずつが自分のライフを持ちます。狙われた子だけがダメージを受け、倒れた子はその場では戦えなくなります。全員が倒れたときだけ負けです。']),
