...
const BATTLE_FX_SETTING_ITEMS = Object.freeze([
  { key:'idleMotion', title:'待機中の動き',
    desc:'待っているあいだのモンスターの動き（翼の羽ばたき・しっぽや花の揺れなど）と、タクティクス新画面の枠の飾り・敵の待機の動きです。攻撃の演出はどちらでも出ます。',
...
const BUILD_DATE = "2026-09-24 17:05"; // 更新のたびに手動で書き換える(日付+時刻、JST) ※version.jsonのbuildも同じ値に合わせること
