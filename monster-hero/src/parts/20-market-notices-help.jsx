...
const MARKET_PROFILE_ICON_STYLES = {
  ...
  //
  // ⚠️ 2026-09-19に「サイズ感が悪い」という指摘を受けて 4.76 まで寄せたが、**実機で悪化した**
  // ので元へ戻した。寄せた判断は 190px の大きな丸を見てのもので、実機のアイコンは 40px しかない。
  // 40pxでは、耳や髪が枠で切れた時点で「何のキャラか分からない青い塊」になる。
  // 見た目を変えるときは **40px で描いて確かめる**こと(190pxで良く見えても当てにならない)。
