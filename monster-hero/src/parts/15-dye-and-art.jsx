...
const MASU_COLOR_REGION_HUES = {
  ...
  Mocchi: [
    { hue: 332, sMin: 0.06, noEdgeGuard: true, notBbox: MOCCHI_EYE_BOXES },
    { hue: 90, sMin: 0.2, noEdgeGuard: true, notBbox: MOCCHI_EYE_BOXES },
    { hue: [35, 12], sMin: 0.22, vMin: 0.3, noEdgeGuard: true, notBbox: MOCCHI_EYE_BOXES },
  ],
