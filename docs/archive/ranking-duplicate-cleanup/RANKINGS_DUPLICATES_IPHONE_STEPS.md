...
`RANKINGS_DUPLICATES_01_CHECK.sql`
...
`RANKINGS_DUPLICATES_02_ROLLBACK.sql`
...
もう一度 `RANKINGS_DUPLICATES_01_CHECK.sql` を全文実行します。
...
`RANKINGS_DUPLICATES_03_COMMIT.sql`
...
`RANKINGS_DUPLICATES_04_VERIFY.sql`
