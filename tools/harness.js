...
const EXPORTED_NAMES = [
  ...
  'autoEnhanceStatTargetsOf',
  'resolveMasuIndividualStats',
  'AUTO_ENHANCE_SETTINGS_VERSION',
  ...
  'buildFusionSoulRankInheritancePlan',
  'buildMasuReincarnation',
  'reconcileMasuPoints',
  ...
  'TRANSCEND_LEVEL_CAP',
  'SOUL_RANK_BASE_LEVEL',
  'SOUL_RANK_MAX_STAGE',
  'SOUL_RANK_LEVEL_CAP',
  'SOUL_RANK_EVOLUTION_STAGES',
  'soulRankEvolutionForStage',
  'soulRankLevelCap',
  'HERO_PROOF_ITEM_ID',
  'HERO_PROOF_ITEM',
  'HERO_PROOF_CLEAR_REWARDS',
  'heroProofClearReward',
  'heroProofShardClearReward',
  'HERO_PROOF_SHARD_CLEAR_REWARDS',
  'soulRankEvolutionStatus',
  'buildMasuSoulRankEvolution',
  'normalizeSoulRankStage',
  'normalizeSoulPointMaxReachedLevel',
  'normalizeSoulTraitLevels',
  'SOUL_TRAIT_DEFINITIONS',
  'SOUL_TRAIT_BY_ID',
  'SOUL_TRAIT_CATEGORIES',
  'soulPointEarned',
  'soulTraitLevel',
  'soulTraitEffectValue',
  'soulTraitSpentPoints',
  'soulTraitAvailablePoints',
  'soulTraitPointStatus',
  'maxSoulTraitUpgradeLevels',
  'buildSoulTraitUpgrade',
  'buildMasuSoulTraitReset',
  'SOUL_RANK_RESPEC_ITEM_ID',
  'SOUL_RANK_RESPEC_DIAMOND_COST',
  'buildSoulRankRespecProofExchange',
  'formatSoulTraitEffect',
  'combineSoulProbabilityPoints',
  'soulTraitPartyPreview',
  'buildUnifiedSpecialDefense',
  'rollUnifiedSpecialDefense',
  'soulTraitAttackProfile',
  'soulRankXpForBondLevel',
  'transcendPointGainForReachedLevel',
  'gainedTranscendPointsBetweenLevels',
  'masuBondLevelInfo',
  'normalizeMasuProgression',
  'resetMasuForRebirth',
  'masuRebirthCost',
  ...
  'ALL_EXTREME_DIFFICULTIES',
  'specialRuleDifficultyForRun',
  'extremeWaveStageRules',
  'HERO_PROOF_SHARD_PER_PROOF',
  'clearPsycheReward',
  'DIFFICULTY_SETTINGS',
