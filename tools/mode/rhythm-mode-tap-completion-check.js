...
check('ノーツ移動は時刻を変えず非線形projectionでpx計算',game.includes('travelPx:judgmentY-spawnY')&&game.includes('rhythmProjectTravelProgress(progress)*travel.travelPx')&&game.includes('yPx=Math.round(yPx);el.style.transform=`translate3d(0,${yPx}px,0)`'));
