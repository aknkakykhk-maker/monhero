...
// 見たいこと(フレーム共有のlayoutを使い回している)は変わっていない。
assert(source.includes('frameLayout?.rect||RHYTHM_VIEW_ROTATION.rectOf(area)')&&source.includes("Object.prototype.hasOwnProperty.call(el,'_rhythmVisualBody')")&&source.includes("el._rhythmVisualBody=body||null;")&&source.includes("RHYTHM_PERF.domQuery();body=el.querySelector('[data-rhythm-hold-body],[data-rhythm-slide-body]')")&&game.includes("if(!visible||!travel)return;"),'共有layout・DOMキャッシュ・非表示skipを維持');
