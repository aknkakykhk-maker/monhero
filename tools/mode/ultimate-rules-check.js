...
assert(source.includes('data-ultimate-battle-status')&&source.includes('ultimateEnemyTurnMultiplier(elapsedTotalTurns)')&&source.includes('ultimateDamageTurnMultiplier(elapsedTotalTurns,ULTIMATE_SETTING.id)'),'battle status must visualize the shared ULTIMATE calculations');
