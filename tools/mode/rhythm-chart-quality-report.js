...
const {HAND_MODEL,noteTouchLane,usableTouchSpan,heldTouchSpan,separationRange,setHandModelFlags}=require('./rhythm-hand-model.js');
...
const measure=(chart,audio,options={})=>{
  const previous=setHandModelFlags(handModelFlagsForRevision(chartRevisionOf(chart)));
