...
ok('review modeは不正配置UI成立後に遅延ロード',calibration.includes("reviewScript.src='debug/rhythm-review-mode.js?v=20260902a'")&&calibration.includes('invalidScript.onload=loadReviewMode')&&calibration.includes("if(document.querySelector('[data-rhythm-invalid-placement-loader]')){loadReviewMode();return;}"));
