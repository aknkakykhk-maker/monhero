...
//
// 【決めごと】
// ・レーンは「押していない」2枚と「押している」2枚を並べる。押したときの見た目を
//   作り替えることがある(2026-09-12に filter をやめて背景と縁へ移した)ので、
//   押していない状態だけを比べると通り抜けてしまう。
...
const pageFor=style=>`<!doctype html><html><head><meta charset="utf-8"><link rel="stylesheet" href="/monster-hero/tailwind.css"><style>
...
<div id="wrap"><div data-rhythm-play-area style="position:absolute;inset:0;overflow:hidden">
  <div class="absolute inset-0 grid grid-cols-4">
    <div data-rhythm-lane data-pressed="false" class="relative border-r border-white/20 bg-slate-900/40" style="border-bottom:3px solid transparent;box-sizing:border-box"></div>
    <div data-rhythm-lane data-pressed="true" class="relative border-r border-white/20 bg-slate-900/40" style="border-bottom:3px solid transparent;box-sizing:border-box"></div>
    <div data-rhythm-lane data-pressed="false" class="relative border-r border-white/20 bg-slate-900/40" style="border-bottom:3px solid transparent;box-sizing:border-box"></div>
    <div data-rhythm-lane data-pressed="true" class="relative border-r border-white/20 bg-slate-900/40" style="border-bottom:3px solid transparent;box-sizing:border-box"></div>
  </div>
