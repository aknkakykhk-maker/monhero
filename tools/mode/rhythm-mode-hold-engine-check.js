...
check('HOLD表示は専用ボディを持ち、rAF内transform/opacity中心',game.includes('data-rhythm-hold-body')&&game.includes("--rhythm-hold-body")&&game.includes('yPx=Math.round(yPx);el.style.transform=`translate3d(0,${yPx}px,0) scale(${settings.noteSize/100})`')&&game.includes('requestAnimationFrame(tick)'));
