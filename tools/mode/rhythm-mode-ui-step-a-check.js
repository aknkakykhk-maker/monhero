...
const m=['data-rhythm-hud','data-rhythm-score','data-rhythm-combo','BEST {Number(bestRecord?.bestScore||0).toLocaleString()}','data-rhythm-judgment-display',"bottom:'calc(12% + 38px)'",'bg-gradient-to-r from-fuchsia-300 via-cyan-100 to-fuchsia-300',"borderBottom=pressed?'3px solid rgba(207,250,254,0.98)'","rhythmMatchInputBatch(run.notes,inputs,now,settings.judgmentTimingOffsetMs)"];
