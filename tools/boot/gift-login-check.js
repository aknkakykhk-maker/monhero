...
check('起動時にお詫びも配る',source.includes('const compensationGrant = grantCompensationGifts(loginGrant.gifts);')&&source.includes('if (loginGrant.granted || compensationGrant.granted || playerCompensationGrant.granted)'));
