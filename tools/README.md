...
| `node masu-baseline-resolution-check.js` | マスモンの旧 `individualStats` / `distApt` が従来値と総合力を保つこと、新 `individualStatOffsets` / `distAptBoosts` が最新ベース変更へ差分を保って追従すること、適性がMを超えないことを確認する。 |
