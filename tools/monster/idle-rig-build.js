...
const RIGS = [
  ...
  { id:'Mitarashi', img:'images/monsters/mitarashi.png', body:'breathe', parts:[
    // だいだい色の翼だけ(赤い体は巻き込まない)
    { name:'wingL', poly:[[7,31],[28,31],[28,53],[7,53]], keep:{ hue:[14,50], minSat:.3, orDark:70 }, pivot:[26,40], anim:'flapL', amp:14, dur:1000, layer:'back' },
    { name:'wingR', poly:[[72,31],[93,31],[93,53],[72,53]], keep:{ hue:[14,50], minSat:.3, orDark:70 }, pivot:[74,40], anim:'flapR', amp:14, dur:1000, layer:'back' },
  ]},
