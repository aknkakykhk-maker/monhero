...
assert(source.includes("const pandoraSplitNormal=mainHero?.id==='Pandora' && activeMon.id==='Pandora' && ['atk','range_atk'].includes(card.type)"));
assert(source.includes('if (pandoraSplitNormal) rollCombo(0.5+comboDmgBonus,true)'));
...
assert(source.includes("const pandoraSplitNormal=mainHero?.id==='Pandora' && mon?.id==='Pandora' && ['atk','range_atk'].includes(card.type)"));
assert(source.includes('if (pandoraSplitNormal) total += extraHit(0.5+comboDmgBonus)'));
