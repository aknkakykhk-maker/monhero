...
//
//   node image/compress-images.js                 # images/ 以下すべてを対象に、実行結果だけ表示(書き換えない)
//   node image/compress-images.js --write         # 実際に書き換える
//   node image/compress-images.js assistant breeder-icons --write   # フォルダを絞る
//
// 【なぜ道具にするか】
