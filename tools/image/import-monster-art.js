...
//
//   node image/import-monster-art.js <元画像> <モンスターID> [--size 1024] [--margin 0.06] [--dry-run]
//   例) node image/import-monster-art.js ../monster-hero/images/monsters/ark.PNG Ark
//
// 【なぜ道具にするか】
...
if (!srcPath || !monsterId) {
  console.log('使い方: node image/import-monster-art.js <元画像> <モンスターID> [--size 1024] [--margin 0.06] [--dry-run]');
  process.exit(1);
}
