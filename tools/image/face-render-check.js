...
const IDS = ['MOCCHI', 'SUEZO', 'PIXIE', 'GOLEM', 'MITARASHI', 'IBLIS', 'TIGER', 'HAM', 'MONOL', 'OBORO', 'ZAN', 'ARK', 'SNEGUROCHKA', 'EIKI', 'KENSHI_MOCCHI'];
...
(async () => {
  ...
  const out = path.join(TOOLS_DIR, 'out', 'face-icons-in-browser.png');
