...
check('転生霊炎は通常時に小さく揺らぎ、完了時だけ強く脈動する',source.includes('className="mh-reincarnate-flame"')&&source.includes('@keyframes mhReincarnateFlame')&&source.includes('scale(1.06)')&&source.includes('@keyframes mhReincarnationAura'));
