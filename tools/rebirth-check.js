...
check('転生霊炎は本体の背面に置き、限界突破★を前面に保つ',source.includes('.mh-reincarnate-aura{position:absolute;z-index:0;')&&source.includes('position:absolute;z-index:0;')&&source.includes('.mh-rebirth-stars-overlay,.mh-home-masumon-stars{z-index:4}'));
