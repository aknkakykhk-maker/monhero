...
| パス | 役割 |
| --- | --- |
| [`monster-hero/`](monster-hero/) | 公開ゲーム本体。`src/parts/*.jsx` が編集元(`src/game-system.jsx` はその連結生成物)、`game-system.compiled.js` が配信用生成物です。`data/`、`audio/`、`icons/`、`images/`、`vendor/` も公開時に参照されます。**ここに置いたものはすべて配信されます。** |
